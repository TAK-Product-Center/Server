 ...
 * 
 * See changes in here commented with "TAKSERVER".
 */
...
public final class OpenSslServerContext extends OpenSslContext {
    ...
    private OpenSslServerContext(
        ...
        // TAKSERVER Update: set these for reuse in updateSslContext(...)
    ...
    // TAKSERVER Update: There is no way to update the truststore on an existing server session.
    ...
    // Existing connections will NOT be disconnecting
    // New connections will be initialized with this updated context
    public void updateSslContext(TrustManagerFactory trustManagerFactory) throws SSLException  {
    	 // Create a new SSL_CTX and configure it.
        boolean success = false;
        try {
        	 sessionContext = newSessionContext(this, ctx, engineMap, trustCertCollection, trustManagerFactory,
