 ...
 * 
 */
public class NettyClientInputTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			NettyClientInputTest client = new NettyClientInputTest();
	...
	private void startClient(ConnectionMeta cm) throws UnknownHostException {
		...
		new Thread(() -> {
			try {
				...
				clientBootstrap.group(bossGroup)
						...
						.handler(new NettyInitializer(cm));
