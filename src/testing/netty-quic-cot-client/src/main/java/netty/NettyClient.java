...
public class NettyClient {
	...
	private static String AUTH = "<auth><cot username=\"test\" password=\"Thisisatest123.\" uid=\"ANDROID-358240051111110\"/></auth>";
	
//	public static class ConnectionMeta {
//		public int port = 8087;
//		public String address = "54.162.113.178";
//		
//		String keyManager = "SunX509";	    
//	    String keystoreType = "JKS";	
//	    // takserver.jks
//		String keystoreFile = "/Users/tingel/Documents/TakAwsCerts/AWS_TAK_1/AWS_TAK_1_ADMIN.jks" ;
//		String keystorePassword = "atakatak";
//		 
//		String truststoreType = "JKS";
//		// truststore-root.jks
//		String truststoreFile = "/Users/tingel/Documents/TakAwsCerts/AWS_TAK_1/truststore-root.jks" ;
...
//	}
	 ...
	 public static class ConnectionMeta {
	     ...
	     String keystoreType = "JKS";	
	     // takserver.jks
	 	String keystoreFile = "/opt/tak/certs/files/admin.jks" ;
	 	String keystorePassword = "atakatak";
	...
	public void startClient() throws UnknownHostException {
		...
		new Thread(() -> {
			try {
				...
				QuicSslContext context = buildClientSslContext();

				 ChannelHandler codec = new QuicClientCodecBuilder()
		                    .sslEngineProvider(q -> context.newEngine(q.alloc(), cm.address, cm.port))
	...
	private QuicSslContext buildClientSslContext() {
		try {
			initTrust();
		} catch (Exception e) {
		...
		sslContext = QuicSslContextBuilder.forClient()
		    .keyManager(keyMgrFactory, cm.keystorePassword)
