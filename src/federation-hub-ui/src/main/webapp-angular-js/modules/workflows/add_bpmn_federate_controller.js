...
angular.module('roger_federation.Workflows')
    .controller('AddBpmnFederateController', ['$rootScope', '$scope', '$stateParams', '$modalInstance', '$log', '$cookieStore', 'growl', 'WorkflowTemplate', 'WorkflowService', 'JointPaper', addBpmnFederateController]);

function addBpmnFederateController($rootScope, $scope, $stateParams, $modalInstance, $log, $cookieStore, growl, WorkflowTemplate, WorkflowService, JointPaper) {
