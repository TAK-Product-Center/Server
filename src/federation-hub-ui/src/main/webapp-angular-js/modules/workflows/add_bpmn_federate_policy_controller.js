...
angular.module('roger_federation.Workflows')
    .controller('AddBpmnFederatePolicyController', ['$rootScope', '$state', '$scope', '$stateParams', '$modalInstance', '$log', '$cookieStore', 'growl', 'WorkflowTemplate', 'WorkflowService', 'JointPaper', addBpmnFederatePolicyController]);

function addBpmnFederatePolicyController($rootScope, $state, $scope, $stateParams, $modalInstance, $log, $cookieStore, growl, WorkflowTemplate, WorkflowService, JointPaper) {
