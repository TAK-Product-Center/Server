...
angular.module('roger_federation.Workflows')
    .controller('AddFederationOutgoingController', ['$rootScope', '$scope', '$http', '$stateParams', '$modalInstance', '$timeout', '$log', '$cookieStore', 'growl', 'WorkflowTemplate', 'WorkflowService', 'JointPaper', addFederationOutgoingController]);

function addFederationOutgoingController($rootScope, $scope, $http, $stateParams, $modalInstance, $timeout, $log, $cookieStore, growl, WorkflowTemplate, WorkflowService, JointPaper) {
