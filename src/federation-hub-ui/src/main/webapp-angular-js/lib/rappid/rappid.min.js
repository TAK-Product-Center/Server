(function(root, factory) {
    ...
    var g = function() {
        function a(b, c) {
            if (!(this instanceof a))
                return new a(b,c);
            var d;
            void 0 === c && Object(b) !== b ? (d = b.split(b.indexOf("@") === -1 ? " " : "@"),
            this.x = parseInt(d[0], 10),
            this.y = parseInt(d[1], 10)) : Object(b) === b ? (this.x = b.x,
            this.y = b.y) : (this.x = b,
            this.y = c)
        }
        function b(c, d) {
            return this instanceof b ? (this.start = a(c),
            void (this.end = a(d))) : new b(c,d)
        }
        function c(a, b, d, e) {
            return this instanceof c ? (void 0 === b && (b = a.y,
            d = a.width,
            e = a.height,
            a = a.x),
            this.x = a,
            this.y = b,
            this.width = d,
            void (this.height = e)) : new c(a,b,d,e)
        }
        function d(b, c, e) {
            return this instanceof d ? (b = a(b),
            this.x = b.x,
            this.y = b.y,
            this.a = c,
            void (this.b = e)) : new d(b,c,e)
        }
        var e = Math
          , f = e.abs
          , h = e.cos
        ...
        a.prototype = {
            ...
            adhereToRect: function(a) {
                return a.containsPoint(this) ? this : (this.x = k(l(this.x, a.x), a.x + a.width),
                this.y = k(l(this.y, a.y), a.y + a.height),
                this)
            },
            theta: function(b) {
                b = a(b);
            ...
            round: function(a) {
                return this.x = a ? this.x.toFixed(a) : n(this.x),
                this.y = a ? this.y.toFixed(a) : n(this.y),
                this
            },
            ...
            toPolar: function(b) {
                ...
                var c = this.x
                  , d = this.y;
                return this.x = j((c - b.x) * (c - b.x) + (d - b.y) * (d - b.y)),
                this.y = s(b.theta(a(c, d))),
                this
            },
            rotate: function(b, c) {
                c = (c + 360) % 360,
        ...
        c.prototype = {
            ...
            containsPoint: function(b) {
                return b = a(b),
                b.x >= this.x && b.x <= this.x + this.width && b.y >= this.y && b.y <= this.y + this.height
            },
            ...
            round: function(a) {
                return this.x = a ? this.x.toFixed(a) : n(this.x),
                this.y = a ? this.y.toFixed(a) : n(this.y),
                this.width = a ? this.width.toFixed(a) : n(this.width),
                this.height = a ? this.height.toFixed(a) : n(this.height),
                this
            },
            normalize: function() {
                var a = this.x
                  ...
                  , c = this.width
                  , d = this.height;
                return this.width < 0 && (a = this.x + this.width,
                c = -this.width),
                this.height < 0 && (b = this.y + this.height,
                d = -this.height),
                this.x = a,
                this.y = b,
                this.width = c,
        ...
        d.prototype = {
            ...
            intersectionWithLineFromCenterToPoint: function(b, c) {
                b = a(b),
                c && b.rotate(a(this.x, this.y), c);
                var d, e = b.x - this.x, f = b.y - this.y;
                if (0 === e)
                    return d = this.bbox().pointNearestToPoint(b),
                    c ? d.rotate(a(this.x, this.y), -c) : d;
                var g = f / e
                  , h = g * g
                  , i = this.a * this.a
                  , k = this.b * this.b
        ...
        var v = {
            ...
            getCurveControlPoints: function(b) {
                ...
                if (1 == f)
                    return d[0] = a((2 * b[0].x + b[1].x) / 3, (2 * b[0].y + b[1].y) / 3),
                    e[0] = a(2 * d[0].x - b[0].x, 2 * d[0].y - b[0].y),
                    [d, e];
                var g = [];
                for (c = 1; c < f - 1; c++)
                    g[c] = 4 * b[c].x + 2 * b[c + 1].x;
                g[0] = b[0].x + 2 * b[1].x,
                g[f - 1] = (8 * b[f - 1].x + b[f].x) / 2;
                var h = this.getFirstControlPoints(g);
                for (c = 1; c < f - 1; ++c)
                    g[c] = 4 * b[c].y + 2 * b[c + 1].y;
                g[0] = b[0].y + 2 * b[1].y,
                g[f - 1] = (8 * b[f - 1].y + b[f].y) / 2;
                var i = this.getFirstControlPoints(g);
                for (c = 0; c < f; c++)
                    d.push(a(h[c], i[c])),
                    c < f - 1 ? e.push(a(2 * b[c + 1].x - h[c + 1], 2 * b[c + 1].y - i[c + 1])) : e.push(a((b[f].x + h[f - 1]) / 2, (b[f].y + i[f - 1]) / 2));
                return [d, e]
            },
    ...
    V = Vectorizer = function() {
        ...
        var b = {
          ...
          , d = function(a, c, e) {
            if (!(this instanceof d))
                return d.apply(Object.create(d.prototype), arguments);
            if (a) {
                if (d.isV(a) && (a = a.node),
                c = c || {},
                d.isString(a))
                    if ("svg" === a.toLowerCase())
                        a = d.createSvgDocument();
                    else if ("<" === a[0]) {
                        var f = d.createSvgDocument(a);
                        if (f.childNodes.length > 1) {
                            var g, h, i = [];
                            for (g = 0,
                            h = f.childNodes.length; g < h; g++) {
                        ...
                        a = document.createElementNS(b.xmlns, a);
                return this.node = a,
                this.node.id || (this.node.id = d.uniqueId()),
        ...
        d.prototype.transform = function(a) {
            if (d.isUndefined(a))
                return this.node.parentNode ? this.getTransformToElement(this.node.parentNode) : this.node.getScreenCTM();
            var b = d.createSVGTransform(a);
            return this.node.transform.baseVal.appendItem(b),
            this
        }
        ,
        d.prototype.translate = function(a, b, c) {
            ...
            var g = c.absolute ? a : f.translate.tx + a
              ...
              , i = "translate(" + g + "," + h + ")";
            return this.attr("transform", (i + " " + e).trim()),
            this
        }
        ,
        d.prototype.rotate = function(a, b, c, e) {
            ...
            if (d.isUndefined(a))
                return g.rotate;
            f = f.replace(/rotate\([^\)]*\)/g, "").trim(),
            a %= 360;
            var h = e.absolute ? a : g.rotate.angle + a
              , i = void 0 !== b && void 0 !== c ? "," + b + "," + c : ""
              , j = "rotate(" + h + i + ")";
            return this.attr("transform", (f + " " + j).trim()),
            this
        }
        ,
        d.prototype.scale = function(a, b) {
            ...
            var f = "scale(" + a + "," + b + ")";
            return this.attr("transform", (c + " " + f).trim()),
            this
        }
        ,
        d.prototype.bbox = function(a, b) {
            ...
            if (a)
                return c;
            var f = this.getTransformToElement(b || this.node.ownerSVGElement);
            return d.transformRect(c, f)
        }
        ,
        d.prototype.text = function(a, b) {
            ...
            if (b.textPath) {
                ...
                var k = d("textPath");
                !b.textPath["xlink:href"] && j && k.attr("xlink:href", "#" + j.node.id),
                Object(b.textPath) === b.textPath && k.attr(b.textPath),
                this.append(k),
                g = k.node
            }
                    ...
                    if (b.annotations) {
                        for (var q = 0, r = d.annotateString(e[m], d.isArray(b.annotations) ? b.annotations : [b.annotations], {
                            ...
                            if (d.isObject(t)) {
                                ...
                                u && u > q && (q = u),
                                c = d("tspan", t.attrs),
                                b.includeAnnotationIndices && c.attr("annotations", t.annotations),
                                t.attrs["class"] && c.addClass(t.attrs["class"]),
                                c.node.textContent = t.t
                            } else
                        ...
                        p.node.textContent = n;
                else
                    p.addClass("v-empty-line"),
                    p.node.style.fillOpacity = 0,
                    p.node.style.strokeOpacity = 0,
                    p.node.textContent = "-";
                d(g).append(p),
                l += n.length + 1
            }
        ...
        d.prototype.removeAttr = function(a) {
            var b = d.qualifyAttr(a)
              , c = this.node;
            return b.ns ? c.hasAttributeNS(b.ns, b.local) && c.removeAttributeNS(b.ns, b.local) : c.hasAttribute(a) && c.removeAttribute(a),
            this
        }
        ,
        d.prototype.attr = function(a, b) {
            if (d.isUndefined(a)) {
                for (var c = this.node.attributes, e = {}, f = 0; f < c.length; f++)
                    e[c[f].nodeName] = c[f].nodeValue;
                return e
            }
            if (d.isString(a) && d.isUndefined(b))
                return this.node.getAttribute(a);
            if ("object" == typeof a)
                for (var g in a)
                    a.hasOwnProperty(g) && this.setAttribute(g, a[g]);
            else
        ...
        d.prototype.setAttributes = function(a) {
            for (var b in a)
                a.hasOwnProperty(b) && this.setAttribute(b, a[b]);
            return this
        }
        ,
        d.prototype.append = function(a) {
            ...
            c = a.length; b < c; b++)
                e = a[b],
                this.node.appendChild(d.isV(e) ? e.node : e.nodeName && e || e[0]);
            return this
        }
        ,
        d.prototype.prepend = function(a) {
            return this.node.insertBefore(d.isV(a) ? a.node : a, this.node.firstChild),
            this
        }
        ,
        ...
        d.prototype.translateAndAutoOrient = function(a, b, c) {
            ...
            return this.translate(p.translateX, p.translateY),
        ...
        d.prototype.toggleClass = function(a, b) {
            ...
            return c ? this.removeClass(a) : this.addClass(a),
            this
        }
        ,
        d.prototype.sample = function(a) {
            a = a || 1;
            for (var b, c = this.node, d = c.getTotalLength(), e = [], f = 0; f < d; )
                b = c.getPointAtLength(f),
                e.push({
                    x: b.x,
                    y: b.y,
                    distance: f
        ...
        d.prototype.findIntersection = function(a, b) {
            ...
            if (e.intersectionWithLineFromCenterToPoint(a)) {
                ...
                if ("RECT" === i) {
                    ...
                    var o, p, q, r, s, t, u = "PATH" === i ? this : this.convertToPath(), v = u.sample(), w = 1 / 0, x = [];
                    for (o = 0; o < v.length; o++)
                        p = v[o],
                        q = d.createSVGPoint(p.x, p.y),
                        q = q.matrixTransform(this.getTransformToElement(b)),
                        p = g.point(q),
                        r = p.distance(f),
                        s = 1.1 * p.distance(a),
                        t = r + s,
        ...
        d.prototype.setAttribute = function(a, b) {
            ...
            return e.ns ? c.setAttributeNS(e.ns, a, b) : "id" === a ? c.id = b : c.setAttribute(a, b),
            this
        }
        ,
        ...
        d.parseXML = function(a, b) {
            b = b || {};
            var c;
            try {
                var e = new DOMParser;
                d.isUndefined(b.async) || (e.async = b.async),
        ...
        d.createSVGTransform = function(a) {
            return d.isUndefined(a) ? e.createSVGTransform() : (a instanceof SVGMatrix || (a = d.createSVGMatrix(a)),
            e.createSVGTransformFromMatrix(a))
        }
        ,
        ...
        d.mergeAttrs = function(a, b) {
            for (var c in b)
                "class" === c ? a[c] = a[c] ? a[c] + " " + b[c] : b[c] : "style" === c ? d.isObject(a[c]) && d.isObject(b[c]) ? a[c] = d.mergeAttrs(a[c], b[c]) : d.isObject(a[c]) ? a[c] = d.mergeAttrs(a[c], d.styleToObject(b[c])) : d.isObject(b[c]) ? a[c] = d.mergeAttrs(d.styleToObject(a[c]), b[c]) : a[c] = d.mergeAttrs(d.styleToObject(a[c]), d.styleToObject(b[c])) : a[c] = b[c];
            return a
        }
        ,
        d.annotateString = function(a, b, c) {
            ...
            for (var e, f, g, h = c.offset || 0, i = [], j = [], k = 0; k < a.length; k++) {
                ...
                g = j[k - 1],
                g ? d.isObject(f) && d.isObject(g) ? JSON.stringify(f.attrs) === JSON.stringify(g.attrs) ? e.t += f.t : (i.push(e),
                e = f) : d.isObject(f) ? (i.push(e),
                e = f) : d.isObject(g) ? (i.push(e),
                e = f) : e = (e || "") + f : e = f
            }
            return e && i.push(e),
            i
        ...
        d.shiftAnnotations = function(a, b, c) {
            return a && a.forEach(function(a) {
                a.start < b && a.end >= b ? a.end += c : a.start >= b && (a.start += c,
                a.end += c)
            }),
            a
        }
        ...
        d.convertPolygonToPathData = function(a) {
            a = d(a);
            var b = d.getPointsFromSvgNode(a.node);
        ...
        d.getPointsFromSvgNode = function(a) {
            var b, c = [];
            for (b = 0; b < a.points.numberOfItems; b++)
                c.push(a.points.getItem(b));
            return c
        }
        ,
        d.KAPPA = .5522847498307935,
        d.convertCircleToPathData = function(a) {
            a = d(a);
        ...
        d.convertRectToPathData = function(a) {
            a = d(a);
            var b, c = parseFloat(a.attr("x")) || 0, e = parseFloat(a.attr("y")) || 0, f = parseFloat(a.attr("width")) || 0, h = parseFloat(a.attr("height")) || 0, i = parseFloat(a.attr("rx")) || 0, j = parseFloat(a.attr("ry")) || 0, k = g.rect(c, e, f, h);
            if (i || j) {
                var l = c + f
                  , m = e + h;
    ...
    var joint = {
        _: "undefined" != typeof _ ? _ : null ,
        $: "undefined" != typeof $ ? $ : null ,
        Backbone: "undefined" != typeof Backbone ? Backbone : null ,
        dagre: "undefined" != typeof dagre ? dagre : null ,
        graphlib: "undefined" != typeof graphlib ? graphlib : null ,
...
//                    return !!document.createElementNS && /SVGForeignObject/.test({}.toString.call(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")))
            ...
            test: function(a) {
                ...
                if (!b)
                    throw new Error('Test not defined ("' + a + '"). Use `joint.env.addTest(name, fn)` to add a new test.');
        ...
        util: {
            ...
            guid: function(a) {
                return this.guid.id = this.guid.id || 1,
                a.id = void 0 === a.id ? "j_" + this.guid.id++ : a.id,
                a.id
            },
            mixin: function() {
                for (var a = arguments[0], b = 1, c = arguments.length; b < c; b++) {
                    ...
                    (Object(d) === d || _.isFunction(d) || null !== d && void 0 !== d) && _.each(d, function(b, c) {
                        return this.mixin.deep && Object(b) === b ? (a[c] || (a[c] = _.isArray(b) ? [] : {}),
                        void this.mixin(a[c], b)) : void (a[c] !== b && (this.mixin.supplement && a.hasOwnProperty(c) || (a[c] = b)))
                    }, this)
                }
                return a
            },
            supplement: function() {
                ...
                return this.mixin.supplement = !1,
                a
            },
            deepMixin: function() {
                this.mixin.deep = !0;
                var a = this.mixin.apply(this, arguments);
                return this.mixin.deep = !1,
                a
            },
            deepSupplement: function() {
                this.mixin.deep = this.mixin.supplement = !0;
                var a = this.mixin.apply(this, arguments);
                return this.mixin.deep = this.mixin.supplement = !1,
                a
            },
            ...
            nextFrame: function() {
                var a;
                if ("undefined" != typeof window && (a = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame),
                !a) {
                    var b = 0;
                    a = function(a) {
            ...
            shapePerimeterConnectionPoint: function(a, b, c, d) {
                ...
                return c ? (f = V(c).findIntersection(d, a.paper.viewport),
                f || (e = g.rect(V(c).bbox(!1, a.paper.viewport)))) : (e = b.model.getBBox(),
                f = e.intersectionWithLineFromCenterToPoint(d)),
                f || e.center()
            },
            breakText: function(a, b, c, d) {
                ...
                i.appendChild(j),
                g.appendChild(h),
                d.svgDocument || document.body.appendChild(g);
                for (var k, l = a.split(" "), m = [], n = [], o = 0, p = 0, q = l.length; o < q; o++) {
                    var r = l[o];
                    if (j.data = n[p] ? n[p] + " " + r : r,
                    i.getComputedTextLength() <= e)
                        n[p] = j.data,
                        k && (m[p++] = !0,
                        k = 0);
                    else {
                        if (!n[p] || k) {
                            ...
                            s || !k) {
                                ...
                                l[o] = r.substring(0, k),
                                l[o + 1] = r.substring(k) + l[o + 1]
                            } else
                                l.splice(o, 1, r.substring(0, k), r.substring(k)),
                                q++,
                                p && !m[p - 1] && p--;
                            o--;
                            continue
                ...
                return d.svgDocument ? g.removeChild(h) : document.body.removeChild(g),
                n.join("\n")
            },
            ...
            setAttributesBySelector: function(a, b) {
                ...
                _.each(b, function(a, b) {
                    ...
                    _.has(a, "class") && (d.addClass(a["class"]),
                    a = _.omit(a, "class")),
                    d.attr(a)
                })
            },
            ...
            format: {
                number: function(a, b, c) {
                    function d(a) {
                        for (var b = a.length, d = [], e = 0, f = c.grouping[0]; b > 0 && f > 0; )
                            ...
                            f = c.grouping[e = (e + 1) % c.grouping.length];
                    ...
                    var e = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i
                      ...
                      , r = ""
                      , s = !1;
                    switch (n && (n = +n.substring(1)),
                    (k || "0" === g && "=" === h) && (k = g = "0",
                    h = "=",
                    m && (l -= Math.floor((l - 1) / 4))),
                    o) {
                    case "n":
                        m = !0,
                        o = "g";
                    ...
                    r = c.currency[1]),
                    "r" != o || n || (o = "g"),
                    null != n && ("g" == o ? n = Math.max(1, Math.min(21, n)) : "e" != o && "f" != o || (n = Math.max(0, Math.min(20, n))));
                    var t = k && m;
                    if (s && b % 1)
                        return "";
                    var u = b < 0 || 0 === b && 1 / b < 0 ? (b = -b,
                    "-") : i
                      , v = r;
                    if (p < 0) {
                    ...
                    u += q,
                    b = y + z,
                    ("<" === h ? u + b + B : ">" === h ? B + u + b : "^" === h ? B.substring(0, A >>= 1) + u + b + B.substring(A) : u + (t ? b : B + b)) + v
                },
                string: function(a, b) {
                    for (var c, d = "{", e = !1, f = []; (c = a.indexOf(d)) !== -1; ) {
                        var g, h, i;
                        if (g = a.slice(0, c),
                        e) {
                            h = g.split(":"),
                ...
                prefix: function(a, b) {
                    var c = _.map(["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"], function(a, b) {
                      ...
                      , d = 0;
                    return a && (a < 0 && (a *= -1),
                    b && (a = this.round(a, this.precision(a, b))),
                    d = 1 + Math.floor(1e-12 + Math.log(a) / Math.LN10),
                    d = Math.max(-24, Math.min(24, 3 * Math.floor((d <= 0 ? d + 1 : d - 1) / 3)))),
                    c[8 + d / 3]
                }
            }
        }
    ...
    joint.mvc.View = Backbone.View.extend({
        ...
        initialize: function(a) {
            this.options = _.extend({}, joint.mvc.View.prototype.options || {}, this.options || {}, a || {}),
    ...
    joint.dia.GraphCells = Backbone.Collection.extend({
        ...
        initialize: function(a, b) {
            ...
            b.cellNamespace && (this.cellNamespace = b.cellNamespace),
            this.graph = b.graph
        },
        model: function(a, b) {
            var c = b.collection
    ...
    joint.dia.Graph = Backbone.Model.extend({
        initialize: function(a, b) {
            ...
            Backbone.Model.prototype.set.call(this, "cells", c),
            c.on("all", this.trigger, this),
            this._out = {},
            this._in = {},
            this._nodes = {},
            this._edges = {},
            c.on("add", this._restructureOnAdd, this),
            c.on("remove", this._restructureOnRemove, this),
            c.on("reset", this._restructureOnReset, this),
            c.on("change:source", this._restructureOnChangeSource, this),
            c.on("change:target", this._restructureOnChangeTarget, this),
            c.on("remove", this._removeCell, this)
        },
        _restructureOnAdd: function(a) {
            if (a.isLink()) {
                ...
                var b = a.get("source")
                  , c = a.get("target");
                b.id && ((this._out[b.id] || (this._out[b.id] = {}))[a.id] = !0),
        ...
        _restructureOnRemove: function(a) {
            if (a.isLink()) {
                ...
                var b = a.get("source")
                  , c = a.get("target");
                b.id && this._out[b.id] && this._out[b.id][a.id] && delete this._out[b.id][a.id],
                c.id && this._in[c.id] && this._in[c.id][a.id] && delete this._in[c.id][a.id]
            } else
        ...
        _restructureOnReset: function(a) {
            ...
            this._nodes = {},
            this._edges = {},
            _.each(a, this._restructureOnAdd, this)
        },
        ...
        toJSON: function() {
            ...
            return a.cells = this.get("cells").toJSON(),
            a
        },
        ...
        set: function(a, b, c) {
            ...
            c = b) : (d = {})[a] = b,
            d.hasOwnProperty("cells") && (this.resetCells(d.cells, c),
            d = _.omit(d, "cells")),
            Backbone.Model.prototype.set.call(this, d, c)
        },
        clear: function(a) {
            a = _.extend({}, a, {
                clear: !0
            ...
            do
                c.shift().remove(a);
            while (c.length > 0);return this.trigger("batch:stop", {
                batchName: "clear"
            }),
            this
        },
        _prepareCell: function(a) {
            var b;
            if (a instanceof Backbone.Model ? (b = a.attributes,
            a.graph = this) : b = a,
            _.isUndefined(b.z) && (b.z = this.maxZIndex() + 1),
            !_.isString(b.type))
        ...
        addCell: function(a, b) {
            return _.isArray(a) ? this.addCells(a, b) : (this.get("cells").add(this._prepareCell(a), b || {}),
            this)
        },
        addCells: function(a, b) {
            return a = _.flattenDeep(a),
            b = b || {},
            b.position = a.length,
            _.each(a, function(a) {
                b.position--,
        ...
        resetCells: function(a, b) {
            return this.get("cells").reset(_.map(a, this._prepareCell, this), b),
            this
        },
        _removeCell: function(a, b, c) {
            c = c || {},
            c.clear || (c.disconnectLinks ? this.disconnectLinks(a, c) : this.removeLinks(a, c)),
            this.get("cells").remove(a, {
                silent: !0
            }),
            delete a.graph
        },
        ...
        getConnectedLinks: function(a, b) {
            ...
            if (d && _.each(this.getOutboundEdges(a.id), function(a, b) {
                f[b] || (e.push(this.getCell(b)),
                f[b] = !0)
            }, this),
            c && _.each(this.getInboundEdges(a.id), function(a, b) {
                f[b] || (e.push(this.getCell(b)),
                f[b] = !0)
            }, this),
            b.deep) {
        ...
        cloneCells: function(a) {
            ...
            _.each(a, function(a) {
                ...
                if (d.isLink()) {
                    var e = d.get("source")
                      , f = d.get("target");
                    e.id && b[e.id] && d.prop("source/id", b[e.id].id),
                    f.id && b[f.id] && d.prop("target/id", b[f.id].id)
                }
                var g = d.get("parent");
                if (g && b[g] && d.set("parent", b[g].id),
                c[d.id]) {
                    var h = [];
        ...
        getSubgraph: function(a, b) {
            ...
            _.each(e, function(a) {
                ...
                _.each(e, function(a) {
                    var b = a.get("source")
                      , e = a.get("target");
                    !d[a.id] && b.id && d[b.id] && e.id && d[e.id] && (c.push(a),
                    d[a.id] = a)
                })
            }, this),
            c
        ...
        search: function(a, b, c) {
            c = c || {},
            c.breadthFirst ? this.bfs(a, b, c) : this.dfs(a, b, c)
        },
        bfs: function(a, b, c) {
            c = c || {};
            var d = {}
        ...
        dfs: function(a, b, c, d, e) {
            ...
            var f = d || {}
              , g = e || 0;
            b(a, g) !== !1 && (f[a.id] = !0,
            _.each(this.getNeighbors(a, c), function(a) {
        ...
        isNeighbor: function(a, b, c) {
            ...
            return _.each(this.getConnectedLinks(a, c), function(a) {
                var g = a.get("source")
                  , h = a.get("target");
                a.hasLoop(c);
                return d && _.has(g, "id") && g.id === b.id ? (f = !0,
                !1) : e && _.has(h, "id") && h.id === b.id ? (f = !0,
                !1) : void 0
            }),
            f
        },
        ...
        getBBox: function(a) {
            return a = a || this.collection.models,
            _.reduce(a, function(a, b) {
    ...
    joint.dia.Cell = Backbone.Model.extend({
            ...
            _.each(b, function(b, d) {
                ...
                _.each(b, function(a, b) {
                    _.isObject(a) && !_.isArray(a) ? _.each(a, function(a, f) {
                        e && e[b] && _.isEqual(e[b][f], a) || (c[d] = c[d] || {},
                        (c[d][b] || (c[d][b] = {}))[f] = a)
                    }) : e && _.isEqual(e[b], a) || (c[d] = c[d] || {},
                    c[d][b] = a)
                })
            });
        ...
        remove: function(a) {
            ...
            return _.invoke(this.getEmbeddedCells(), "remove", a),
            this.trigger("remove", this, this.collection, a),
            b && b.trigger("batch:stop", {
                batchName: "remove"
            }),
            this
        },
        ...
        embed: function(a, b) {
            ...
            return c[a.isLink() ? "unshift" : "push"](a.id),
            a.set("parent", this.id, b),
            this.set("embeds", _.uniq(c), b),
            this.trigger("batch:stop", {
                batchName: "embed"
            }),
            this
        ...
        unembed: function(a, b) {
            ...
            a.unset("parent", b),
            this.set("embeds", _.without(this.get("embeds"), a.id), b),
            this.trigger("batch:stop", {
                batchName: "unembed"
            }),
            this
                ...
                if (a.deep)
                    if (a.breadthFirst) {
                        ...
                        for (var c = this.getEmbeddedCells(); c.length > 0; ) {
                            var d = c.shift();
                            b.push(d),
                            c.push.apply(c, d.getEmbeddedCells())
                        }
                    } else
                        b = this.getEmbeddedCells(),
                        _.each(b, function(c) {
        ...
        clone: function(a) {
            ...
            return b.set("id", joint.util.uuid()),
            b.set("embeds", ""),
            b
        },
        prop: function(a, b, c) {
        ...
        removeProp: function(a, b) {
            ...
            return joint.util.unsetByPath(f, e, "/"),
            this.set(d, f, b)
        },
        attr: function(a, b, c) {
        ...
        removeAttr: function(a, b) {
            ...
            this) : this.removeProp("attrs/" + a, b)
        },
        transition: function(a, b, c, d) {
            ...
            var f, g = 0, h = _.bind(function(b) {
                ...
                b -= g,
                e = b / c.duration,
                e < 1 ? this._transitionIds[a] = d = joint.util.nextFrame(h) : (e = 1,
                delete this._transitionIds[a]),
                i = f(c.timingFunction(e)),
                c.transitionId = d,
                this.prop(a, i, c),
                d || this.trigger("transition:end", this, a)
            }, this), i = _.bind(function(e) {
                this.stopTransitions(a),
                f = c.valueFunction(joint.util.getByPath(this.attributes, a, d), b),
                this._transitionIds[a] = joint.util.nextFrame(e),
                this.trigger("transition:start", this, a)
            }, this);
        ...
        stopTransitions: function(a, b) {
            ...
            return _(this._transitionIds).keys().filter(c && function(a) {
                ...
                joint.util.cancelFrame(this._transitionIds[a]),
                delete this._transitionIds[a],
                this.trigger("transition:end", this, a)
            }, this),
            this
        },
        addTo: function(a, b) {
            return a.addCell(this, b),
            this
        },
        findView: function(a) {
    ...
    joint.dia.CellView = joint.mvc.View.extend({
        ...
        constructor: function(a) {
            a.id = a.id || joint.util.guid(this),
            joint.mvc.View.call(this, a)
        },
        init: function() {
        ...
        _ensureElement: function() {
            ...
            if (this.el)
                ...
                this.className && (b["class"] = _.result(this, "className")),
                a = V(_.result(this, "tagName"), b).node
            }
            this.setElement(a, !1)
        },
        ...
        notify: function(a) {
            if (this.paper) {
                ...
                this.trigger.apply(this, [a].concat(b)),
                this.paper.trigger.apply(this.paper, [a, this].concat(b))
            }
        },
        getStrokeBBox: function(a) {
            ...
            return c = b ? V(a).attr("stroke-width") : this.model.attr("rect/stroke-width") || this.model.attr("circle/stroke-width") || this.model.attr("ellipse/stroke-width") || this.model.attr("path/stroke-width"),
            c = parseFloat(c) || 0,
            g.rect(d).moveAndExpand({
                x: -c / 2,
                y: -c / 2,
                width: c,
                height: c
        ...
        highlight: function(a, b) {
            return a = a ? this.$(a)[0] || this.el : this.el,
            b = b || {},
            b.partial = a != this.el,
            this.notify("cell:highlight", a, b),
            this
        },
        unhighlight: function(a, b) {
            ...
            b = b || {},
            b.partial = a != this.el,
            this.notify("cell:unhighlight", a, b),
            this
        },
        ...
        applyFilter: function(a, b) {
            ...
            if (!this.paper.svg.getElementById(d)) {
                ...
                b.attrs && f.attr(b.attrs),
                f.node.id = d,
                V(this.paper.svg).defs().append(f)
            }
            c.each(function() {
        ...
        applyGradient: function(a, b, c) {
            ...
            if (!this.paper.svg.getElementById(e)) {
                var f = ["<" + c.type + ">", _.map(c.stops, function(a) {
                  ...
                  , g = V(f);
                c.attrs && g.attr(c.attrs),
                g.node.id = e,
                V(this.paper.svg).defs().append(g)
            }
            d.each(function() {
                V(this).attr(b, "url(#" + e + ")")
            })
        ...
        getSelector: function(a, b) {
            ...
            return b && (d += " > " + b),
            this.getSelector(a.parentNode, d)
        },
        ...
        pointerdown: function(a, b, c) {
            ...
            this.notify("cell:pointerdown", a, b, c)
        },
        pointermove: function(a, b, c) {
            this.notify("cell:pointermove", a, b, c)
        },
        pointerup: function(a, b, c) {
            this.notify("cell:pointerup", a, b, c),
            this._collection && (this._collection.trigger("batch:stop", {
                batchName: "pointer"
            }),
    ...
    joint.dia.Element = joint.dia.Cell.extend({
        ...
        translate: function(a, b, c) {
            ...
            0 === a && 0 === b)
                return this;
            c = c || {},
            c.translateBy = c.translateBy || this.id;
            ...
            return c.tx = a,
            c.ty = b,
            c.transition ? (_.isObject(c.transition) || (c.transition = {}),
            this.transition("position", k, _.extend({}, c.transition, {
                valueFunction: joint.util.interpolate.object
            }))) : this.set("position", k, c),
            _.invoke(this.getEmbeddedCells(), "translate", a, b, c),
            this
        },
        resize: function(a, b, c) {
            if (c = c || {},
            this.trigger("batch:start", _.extend({}, c, {
                element: this,
                batchName: "resize"
            })),
            c.direction) {
                ...
                c.absolute && (f += Math.floor((e + 45) / 90),
                f %= 4);
                var h = this.getBBox()
    ...
    joint.dia.ElementView = joint.dia.CellView.extend({
        ...
        update: function(a, b) {
            ...
            _.each(b || c, function(a, b) {
                ...
                if (0 !== c.length) {
                    ...
                    _.isObject(a.filter) && (d.push("filter"),
                    this.applyFilter(c, a.filter)),
                    _.isObject(a.fill) && (d.push("fill"),
                    this.applyGradient(c, "fill", a.fill)),
                    _.isObject(a.stroke) && (d.push("stroke"),
                    this.applyGradient(c, "stroke", a.stroke)),
                    _.isUndefined(a.text) || (c.each(function() {
                        V(this).text(a.text + "", {
                    ...
                    a.port && c.attr("port", _.isUndefined(a.port.id) ? a.port : a.port.id),
                    a.style && c.css(a.style),
                    _.isUndefined(a.html) || c.each(function() {
                        $(this).html(a.html + "")
                    }),
        ...
        positionRelative: function(a, b, c, d) {
            ...
            if (e) {
                var s;
                if (s = d && d[e] ? V(d[e][0]) : "." === e ? this.vel : this.vel.findOne(e),
                !s)
                    throw new Error("dia.ElementView: reference does not exists.");
                b = s.bbox(!1, this.el)
            }
            a.attr("transform") && a.attr("transform", a.attr("transform").replace(/translate\([^)]*\)/g, "").trim() || ""),
            isFinite(n) && (o || n >= 0 && n <= 1 ? a.attr("width", n * b.width) : a.attr("width", Math.max(n + b.width, 0))),
            isFinite(p) && (q || p >= 0 && p <= 1 ? a.attr("height", p * b.height) : a.attr("height", Math.max(p + b.height, 0)));
            var t, u = 0, v = 0;
            if (isFinite(f) && (r ? (t = t || r.scale(),
            u = b.x + b.width + f / t.sx) : u = b.x + b.width + f),
            isFinite(g) && (r ? (t = t || r.scale(),
            v = b.y + b.height + g / t.sy) : v = b.y + b.height + g),
            isFinite(l) && (m || l > 0 && l < 1 ? u = b.x + b.width * l : r ? (t = t || r.scale(),
            u = b.x + l / t.sx) : u = b.x + l),
            isFinite(j) && (m || j > 0 && j < 1 ? v = b.y + b.height * j : r ? (t = t || r.scale(),
            v = b.y + j / t.sy) : v = b.y + j),
            !_.isUndefined(h) || !_.isUndefined(i)) {
                var w = a.bbox(!1, this.paper.viewport);
                "middle" === h ? v -= w.height / 2 : isFinite(h) && (v += h > -1 && h < 1 ? w.height * h : h),
                "middle" === i ? u -= w.width / 2 : isFinite(i) && (u += i > -1 && i < 1 ? w.width * i : i)
            }
            a.translate(u, v)
        },
        ...
        finalizeEmbedding: function(a) {
            ...
            delete this._candidateEmbedView),
            _.invoke(d.model.getConnectedLinks(c, {
                deep: !0
            }), "reparent", {
                ui: !0
            })
        ...
        pointerdown: function(a, b, c) {
            ...
            if (a.target.getAttribute("magnet") && d.options.validateMagnet.call(d, this, a.target)) {
                ...
                f.pointerdown(a, b, c),
                f.startArrowheadMove("target", {
                    whenNotAllowed: "remove"
                })
            } else
                this._dx = b,
                this._dy = c,
                this.restrictedArea = d.getRestrictedArea(this),
                joint.dia.CellView.prototype.pointerdown.apply(this, arguments),
                this.notify("element:pointerdown", a, b, c)
        },
        pointermove: function(a, b, c) {
            if (this._linkView)
                ...
                if (e !== !1) {
                    ...
                    this.paper.options.embeddingMode && (this._inProcessOfEmbedding || (this.prepareEmbedding(),
                    this._inProcessOfEmbedding = !0),
                    this.processEmbedding())
                }
                this._dx = g.snapToGrid(b, d),
                this._dy = g.snapToGrid(c, d),
                joint.dia.CellView.prototype.pointermove.apply(this, arguments),
                this.notify("element:pointermove", a, b, c)
            }
        },
        pointerup: function(a, b, c) {
            this._linkView ? (this._linkView.pointerup(a, b, c),
            this._linkView = null ,
            this.model.trigger("batch:stop", {
                batchName: "add-link"
            })) : (this._inProcessOfEmbedding && (this.finalizeEmbedding(),
            this._inProcessOfEmbedding = !1),
            this.notify("element:pointerup", a, b, c),
    ...
    joint.dia.Link = joint.dia.Cell.extend({
        ...
        reparent: function(a) {
            ...
            if (this.graph) {
                ...
                c && d && (b = this.graph.getCommonAncestor(c, d)),
                !e || b && b.id === e.id || e.unembed(this, a),
                b && b.embed(this, a)
            }
            return b
        },
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        initialize: function(a) {
            joint.dia.CellView.prototype.initialize.apply(this, arguments),
            "function" != typeof this.constructor.prototype.watchSource && (this.constructor.prototype.watchSource = this.createWatcher("source"),
        ...
        startListening: function() {
            var a = this.model;
            this.listenTo(a, "change:markup", this.render),
            this.listenTo(a, "change:smooth change:manhattan change:router change:connector", this.update),
            this.listenTo(a, "change:toolMarkup", this.onToolsChange),
            this.listenTo(a, "change:labels change:labelMarkup", this.onLabelsChange),
            this.listenTo(a, "change:vertices change:vertexMarkup", this.onVerticesChange),
            this.listenTo(a, "change:source", this.onSourceChange),
            this.listenTo(a, "change:target", this.onTargetChange)
        },
        onSourceChange: function(a, b, c) {
            this.watchSource(a, b),
            c.translateBy && this.model.get("target").id || (c.updateConnectionOnly = !0,
            this.update(this.model, null , c))
        },
        onTargetChange: function(a, b, c) {
            this.watchTarget(a, b),
            c.translateBy || (c.updateConnectionOnly = !0,
            this.update(this.model, null , c))
        },
        onVerticesChange: function(a, b, c) {
            this.renderVertexMarkers(),
            c.translateBy && c.translateBy !== this.model.id || (c.updateConnectionOnly = !0,
            this.update(a, null , c))
        },
        ...
        render: function() {
            ...
            this.vel.append(b),
            this.renderLabels(),
            this.watchSource(a, a.get("source")).watchTarget(a, a.get("target")).update(),
            this
        },
        renderLabels: function() {
            ...
            return _.each(b, function(b, c) {
                var f = d.clone().node;
                V(f).attr("label-idx", c),
                e && V(f).attr("cursor", "move"),
                this._labelCache[c] = V(f);
                var g = $(f).find("text")
                  , h = $(f).find("rect")
                  , i = _.extend({
                    "text-anchor": "middle",
                ...
                g.attr(_.omit(i, "text")),
                _.isUndefined(i.text) || V(g[0]).text(i.text + "", {
        ...
        renderTools: function() {
            ...
            this.options.doubleLinkTools) {
                var d;
                this.model.get("doubleToolMarkup") || this.model.doubleToolMarkup ? (b = _.template(this.model.get("doubleToolMarkup") || this.model.doubleToolMarkup),
                d = V(b())) : d = c.clone(),
                a.append(d.node),
                this._tool2Cache = d
            }
        ...
        renderArrowheadMarkers: function() {
            ...
            a.append(this._V.sourceArrowhead.node, this._V.targetArrowhead.node),
            this
        },
        update: function(a, b, c) {
            return c = c || {},
            c.updateConnectionOnly || this.updateAttributes(),
            this.updateConnection(c),
            this.updateLabelPositions(),
            this.updateToolsPosition(),
            this.updateArrowheadMarkers(),
            this.options.perpendicular = null ,
            this.updatePostponed = !1,
            this
        },
        updateConnection: function(a) {
            ...
            if (a.translateBy && c.isRelationshipEmbeddedIn(a.translateBy)) {
                ...
                b = this.route = this.findRoute(c.get("vertices") || [], a),
                this._findConnectionPoints(b);
            var f = this.getPathData(b);
            this._V.connection.attr("d", f),
            this._V.connectionWrap && this._V.connectionWrap.attr("d", f),
            this._translateAndAutoOrientArrows(this._V.markerSource, this._V.markerTarget)
        },
        updateAttributes: function() {
            _.each(this.model.get("attrs"), function(a, b) {
                var c = [];
                _.isObject(a.fill) && (this.applyGradient(b, "fill", a.fill),
                c.push("fill")),
                _.isObject(a.stroke) && (this.applyGradient(b, "stroke", a.stroke),
                c.push("stroke")),
                _.isObject(a.filter) && (this.applyFilter(b, a.filter),
                c.push("filter")),
                c.length > 0 && (c.unshift(a),
                a = _.omit.apply(_, c)),
                this.findBySelector(b).attr(a)
            }, this)
        },
        _findConnectionPoints: function(a) {
            ...
            this._V.markerSource && (i.sourceBBox = i.sourceBBox || this._V.markerSource.bbox(!0),
            d = g.point(b).move(f || c, i.sourceBBox.width * this._V.markerSource.scale().sx * -1).round()),
            this._V.markerTarget && (i.targetBBox = i.targetBBox || this._V.markerTarget.bbox(!0),
            e = g.point(c).move(h || b, i.targetBBox.width * this._V.markerTarget.scale().sx * -1).round()),
            i.sourcePoint = d || b,
            i.targetPoint = e || c,
            this.sourcePoint = b,
            this.targetPoint = c
        ...
        _translateConnectionPoints: function(a, b) {
            ...
            c.sourcePoint.offset(a, b),
            c.targetPoint.offset(a, b),
            this.sourcePoint.offset(a, b),
            this.targetPoint.offset(a, b)
        },
            ...
            if (!_.isNaN(c)) {
                ...
                _.each(a, function(a, e) {
                    ...
                    if (_.isObject(i))
                        ...
                        for (var k, l, m, n, o = 1 / 0, p = 0, q = d.length; p < q; p++)
                            m = d[p],
                            n = g.line(m, j).squaredLength(),
                            n < o && (o = n,
                            k = m,
                            l = p);
                        var r = d[l - 1]
                          , s = d[l + 1]
                          , t = 0;
                        s ? t = g.point(j).theta(s) : r && (t = g.point(r).theta(j)),
                        j = g.point(j).offset(i).rotate(j, t - 90)
                    }
        ...
        updateToolsPosition: function() {
            ...
            if (!_.isNaN(c)) {
                c < this.options.shortLinkLength && (a = "scale(.5)",
                b /= 2);
                var d = this.getPointAtLength(b);
                if (this._toolCache.attr("transform", "translate(" + d.x + ", " + d.y + ") " + a),
                this.options.doubleLinkTools && c >= this.options.longLinkLength) {
                    var e = this.options.doubleLinkToolsOffset || b;
                    d = this.getPointAtLength(c - e),
                    this._tool2Cache.attr("transform", "translate(" + d.x + ", " + d.y + ") " + a),
        ...
        updateArrowheadMarkers: function() {
            ...
            return this._V.sourceArrowhead.scale(a),
            this._V.targetArrowhead.scale(a),
        ...
        createWatcher: function(a) {
            function b(b, d) {
                ...
                var e = null
                  , f = b.previous(a) || {};
                return f.id && this.stopListening(this.paper.getModelById(f.id), "change", c),
                d.id && (e = this.paper.getModelById(d.id),
                this.listenTo(e, "change", c)),
                c.call(this, e, {
                    cacheOnly: !0
                }),
                this
        ...
        onEndModelChange: function(a, b, c) {
            ...
            if (b) {
                ...
                if (c.handleBy === this.cid && h == k)
                    this[a + "BBox"] = this[i + "BBox"],
                    this[a + "View"] = this[i + "View"],
                    this[a + "Magnet"] = this[i + "Magnet"];
                    ...
                    this[a + "BBox"] = m.getStrokeBBox(n),
                    this[a + "View"] = m,
                    this[a + "Magnet"] = n
                }
                if (c.handleBy === this.cid && c.translateBy && e.isEmbeddedIn(b) && !_.isEmpty(e.get("vertices")) && (d = !1),
                !this.updatePostponed && j.id) {
                    var o = this.paper.getModelById(j.id);
                    f.id === j.id && (c.handleBy = this.cid),
                    (c.handleBy === this.cid || c.translateBy && o.isEmbeddedIn(c.translateBy)) && (this.updatePostponed = !0,
                    d = !1)
                }
            } else
                this[a + "BBox"] = g.rect(f.x || 0, f.y || 0, 1, 1),
                this[a + "View"] = this[a + "Magnet"] = null ;
            d && (c.updateConnectionOnly = !0,
            this.update(e, null , c))
        },
        _translateAndAutoOrientArrows: function(a, b) {
            a && a.translateAndAutoOrient(this.sourcePoint, _.first(this.route) || this.targetPoint, this.paper.viewport),
            b && b.translateAndAutoOrient(this.targetPoint, _.last(this.route) || this.sourcePoint, this.paper.viewport)
        },
        removeVertex: function(a) {
            var b = _.clone(this.model.get("vertices"));
            return b && b.length && (b.splice(a, 1),
            this.model.set("vertices", b, {
                ui: !0
            })),
            this
        },
        addVertex: function(a) {
            for (var b, c = (this.model.get("vertices") || []).slice(), d = c.slice(), e = this._V.connection.node.cloneNode(!1), f = e.getTotalLength(), g = 20, h = c.length + 1; h-- && (c.splice(h, 0, a),
            V(e).attr("d", this.getPathData(this.findRoute(c))),
            b = e.getTotalLength(),
            b - f > g); )
                c = d.slice();
            return h === -1 && (h = 0,
            c.splice(h, 0, a)),
            this.model.set("vertices", c, {
                ui: !0
            }),
            h
        },
        sendToken: function(a, b, c) {
            b = b || 1e3,
            V(this.paper.viewport).append(a),
            V(a).animateAlongPath({
                dur: b + "ms",
                repeatCount: 1
        ...
        getConnectionPoint: function(a, b, c) {
            ...
            b.id) {
                ...
                if (c.id) {
                    ...
                    e = g.rect(h).intersectionWithLineFromCenterToPoint(g.rect(f).center()),
                    e = e || g.rect(h).center()
                } else
                    e = g.point(c);
                if (this.paper.options.perpendicularLinks || this.options.perpendicular) {
                    ...
                    if (j.intersect(g.rect(f)))
                        ...
                        d = g.rect(f).intersectionWithLineFromCenterToPoint(e),
                        d = d || g.rect(f).center()
        ...
        _beforeArrowheadMove: function() {
            ...
            this.paper.options.markAvailable && this._markAvailableMagnets()
        },
        _afterArrowheadMove: function() {
            ...
            this.paper.options.markAvailable && this._unmarkAvailableMagnets()
        },
        _createValidateConnectionArgs: function(a) {
            function b(a, b) {
                return c[f] = a,
                c[f + 1] = a.el === b ? void 0 : b,
                c
            }
            var c = [];
            c[4] = a,
            ...
            return g.id && (c[e] = this.paper.findViewByModel(g.id),
            c[e + 1] = g.selector && c[e].el.querySelector(g.selector)),
            b
        },
        _markAvailableMagnets: function() {
            ...
            _.chain(a).map(this.paper.findViewByModel, this.paper).each(function(a) {
                ...
                c && V(a.el).addClass("available-magnet"),
                _.each(d, function(a) {
        ...
        startArrowheadMove: function(a, b) {
            ...
            this._whenNotAllowed = b.whenNotAllowed,
            this._arrowhead = a,
            this._initialEnd = _.clone(this.model.get(a)) || {
                x: 0,
                y: 0
            },
        ...
        can: function(a) {
            ...
            return b !== !1 && (!_.isObject(b) || b[a] !== !1)
        },
        pointerdown: function(a, b, c) {
            if (joint.dia.CellView.prototype.pointerdown.apply(this, arguments),
            this.notify("link:pointerdown", a, b, c),
            this._dx = b,
            this._dy = c,
            null == a.target.getAttribute("magnet")) {
                ...
                if (d !== !1) {
                    ...
                    switch ("label" === g ? (f = g,
                    e = a.target.parentNode) : e = a.target,
                    f) {
                    case "marker-vertex":
                        this.can("vertexMove") && (this._action = "vertex-move",
                        this._vertexIdx = a.target.getAttribute("idx"));
                        break;
                    ...
                    case "marker-arrowhead":
                        ...
                        break;
                    case "label":
                        this.can("labelMove") && (this._action = "label-move",
                        this._labelIdx = parseInt(V(e).attr("label-idx"), 10),
        ...
        pointermove: function(a, b, c) {
            ...
            case "label-move":
                for (var e, f, h, i, j = {
                    x: b,
                    y: c
                }, k = (this.model.get("labels")[this._labelIdx],
                this._samples), l = 1 / 0, m = 0, n = k.length; m < n; m++)
                    h = k[m],
                    i = g.line(h, j).squaredLength(),
                    i < l && (l = i,
                    e = h,
                    f = m);
                var o = k[f - 1]
                  , p = k[f + 1]
                  , q = (g.point(e).distance(j),
                0);
                o && p ? q = g.line(o, p).pointOffset(j) : o ? q = g.line(o, e).pointOffset(j) : p && (q = g.line(e, p).pointOffset(j)),
            ...
            case "arrowhead-move":
                if (this.paper.options.snapLinks) {
                    ...
                    _.each(s, function(a) {
                        "false" !== a.el.getAttribute("magnet") && (t = a.model.getBBox().center().distance(v),
                        t < r && t < u && this.paper.options.validateConnection.apply(this.paper, this._validateConnectionArgs(a, null )) && (u = t,
                        this._closestView = a,
                        this._closestEnd = {
                            id: a.model.id
                        })),
                        a.$("[magnet]").each(_.bind(function(b, c) {
                            ...
                            t < r && t < u && this.paper.options.validateConnection.apply(this.paper, this._validateConnectionArgs(a, c)) && (u = t,
                            this._closestView = a,
                            this._closestEnd = {
                                id: a.model.id,
                    ...
                    this._viewUnderPointer = this.paper.findView(w),
                    this._viewUnderPointer ? (this._magnetUnderPointer = this._viewUnderPointer.findMagnet(w),
                    this._magnetUnderPointer && this.paper.options.validateConnection.apply(this.paper, this._validateConnectionArgs(this._viewUnderPointer, this._magnetUnderPointer)) ? this._magnetUnderPointer && this._viewUnderPointer.highlight(this._magnetUnderPointer, {
                        connecting: !0
                    }) : this._magnetUnderPointer = null ) : this._magnetUnderPointer = null ),
                    this._targetEvent = w,
            ...
            this._dy = c,
            joint.dia.CellView.prototype.pointermove.apply(this, arguments),
            this.notify("link:pointermove", a, b, c)
        },
        pointerup: function(a, b, c) {
            if ("label-move" === this._action)
                ...
                if (d.snapLinks)
                    ...
                    if (this._viewUnderPointer = null ,
                ...
                d.embeddingMode && this.model.reparent() && (this._z = null ),
                this._afterArrowheadMove()
            }
            this._action = null ,
            this._whenNotAllowed = null ,
            this.notify("link:pointerup", a, b, c),
            joint.dia.CellView.prototype.pointerup.apply(this, arguments)
        }
    }, {
        makeSelector: function(a) {
            var b = '[model-id="' + a.id + '"]';
            return a.port ? b += ' [port="' + a.port + '"]' : a.selector && (b += " " + a.selector),
            b
        }
    }),
    joint.dia.Paper = joint.mvc.View.extend({
        ...
        setDimensions: function(a, b) {
            a = this.options.width = a || this.options.width,
            b = this.options.height = b || this.options.height,
            V(this.svg).attr({
                width: a,
                height: b
            }),
        ...
        setOrigin: function(a, b) {
            this.options.origin.x = a || 0,
            this.options.origin.y = b || 0,
            V(this.viewport).translate(a, b, {
                absolute: !0
            }),
        ...
        fitToContent: function(a, b, c, d) {
            ...
            var g = Math.max(Math.ceil((e.width + e.x) / a), 1) * a
              ...
              , i = 0
              , j = 0;
            ("negative" == d.allowNewOrigin && e.x < 0 || "positive" == d.allowNewOrigin && e.x >= 0 || "any" == d.allowNewOrigin) && (i = Math.ceil(-e.x / a) * a,
            i += c.left,
            g += i),
            ("negative" == d.allowNewOrigin && e.y < 0 || "positive" == d.allowNewOrigin && e.y >= 0 || "any" == d.allowNewOrigin) && (j = Math.ceil(-e.y / b) * b,
            j += c.top,
            h += j),
            g += c.right,
            h += c.bottom,
            g = Math.max(g, d.minWidth || 0),
            h = Math.max(h, d.minHeight || 0),
            g = Math.min(g, d.maxWidth || Number.MAX_VALUE),
            h = Math.min(h, d.maxHeight || Number.MAX_VALUE);
            var k = g != this.options.width || h != this.options.height
              , l = i != this.options.origin.x || j != this.options.origin.y;
            l && this.setOrigin(i, j),
            k && this.setDimensions(g, h)
        },
        scaleContentToFit: function(a) {
            ...
            if (b.width && b.height) {
                ...
                if (a.preserveAspectRatio && (k = l = Math.min(k, l)),
                a.scaleGrid) {
                    var m = a.scaleGrid;
                    k = m * Math.floor(k / m),
                    l = m * Math.floor(l / m)
                }
                k = Math.min(e, Math.max(d, k)),
                l = Math.min(h, Math.max(f, l)),
                this.scale(k, l);
        ...
        createViewForModel: function(a) {
            ...
            a.isLink() ? (b = this.options.linkView,
            c = joint.dia.LinkView) : (b = this.options.elementView,
            c = joint.dia.ElementView);
        ...
        onCellAdded: function(a, b, c) {
            if (this.options.async && c.async !== !1 && _.isNumber(c.position)) {
                if (this._asyncCells = this._asyncCells || [],
                this._asyncCells.push(a),
                0 == c.position) {
                    if (this._frameId)
                        throw new Error("another asynchronous rendering in progress");
                    this.asyncRenderViews(this._asyncCells, c),
        ...
        removeView: function(a) {
            ...
            return b && (b.remove(),
            delete this._views[a.id]),
            b
        },
        renderView: function(a) {
            var b = this._views[a.id] = this.createViewForModel(a);
            return V(this.viewport).append(b.el),
            b.paper = this,
            b.render(),
            $(b.el).find("image").on("dragstart", function() {
                return !1
            }),
            b
        },
        ...
        resetViews: function(a, b) {
            ...
            c = this.beforeRenderViews(c, b) || c,
            this._frameId && (joint.util.cancelFrame(this._frameId),
            delete this._frameId),
            this.options.async ? this.asyncRenderViews(c, b) : (_.each(c, this.renderView, this),
            this.sortViews())
        },
        ...
        asyncRenderViews: function(a, b) {
            ...
            }, this) : (delete this._frameId,
            this.afterRenderViews(b),
            this.trigger("render:done", b))
        },
        sortViews: function() {
        ...
        scale: function(a, b, c, d) {
            ...
            return V(this.viewport).scale(a, b),
            this.trigger("scale", a, b, c, d),
            this
        },
        rotate: function(a, b, c) {
            if (_.isUndefined(b)) {
        ...
        clientToLocalPoint: function(a) {
            ...
            return a.offset(e - c.left, d - c.top),
            V.transformPoint(a, this.viewport.getCTM().inverse())
        },
        ...
        guard: function(a, b) {
            return !(!this.options.guard || !this.options.guard(a, b)) || !(b && b.model && b.model instanceof joint.dia.Cell) && (this.svg !== a.target && this.el !== a.target && !$.contains(this.svg, a.target))
        },
        ...
        pointerdown: function(a) {
            ...
            if (!this.guard(a, b)) {
                ...
                b ? (this.sourceView = b,
                b.pointerdown(a, c.x, c.y)) : this.trigger("blank:pointerdown", a, c.x, c.y)
            }
        },
        ...
        pointerup: function(a) {
            ...
            this.sourceView ? (this.sourceView.pointerup(a, b.x, b.y),
            this.sourceView = null ) : this.trigger("blank:pointerup", a, b.x, b.y)
        },
    ...
    joint.shapes.basic.PortsModelInterface = {
        ...
        updatePortsAttrs: function(a) {
            ...
            _.each(this.get("inPorts"), function(a, b, d) {
                ...
                this._portSelectors = this._portSelectors.concat(_.keys(e)),
                _.extend(c, e)
            }, this),
            _.each(this.get("outPorts"), function(a, b, d) {
    ...
    joint.shapes.basic.TextBlockView = joint.dia.ElementView.extend({
        initialize: function() {
            ...
            joint.env.test("svgforeignobject") || this.listenTo(this.model, "change:content", function(a) {
        ...
        update: function(a, b) {
            if (joint.env.test("svgforeignobject")) {
                ...
                joint.dia.ElementView.prototype.update.call(this, c, d),
                b && !_.has(b, ".content") || this.updateContent(c, b)
            } else
        ...
        updateContent: function(a, b) {
            ...
            e[".content"].text = d,
            joint.dia.ElementView.prototype.update.call(this, a, e)
        }
    }),
    joint.routers.orthogonal = function() {
        ...
        function f(a, b, c) {
            ...
            return c.containsPoint(d) && (d = g.point(b.x, a.y)),
            d
        }
        function h(b, c, d) {
            ...
            if (e.containsPoint(k)) {
                ...
                if (f.containsPoint(l)) {
                    var m = g.point(c).move(l, -b(e, a(c, l)) / 2)
                      ...
                      , p = i(c, o, e)
                      , q = h(o, d, p.direction);
                    j.points = [p.points[0], q.points[0]],
                    j.direction = q.direction
                }
            }
            return j
        }
        function l(b, d, h, i, j) {
            ...
            return j ? (k = g.point.fromPolar(p.width + p.height, o[j], r),
            k = p.pointNearestToPoint(k).move(k, -1)) : k = p.pointNearestToPoint(r).move(r, 1),
            l = f(k, s, p),
            k.round().equals(l.round()) ? (l = g.point.fromPolar(p.width + p.height, g.toRad(k.theta(r)) + Math.PI / 2, s),
            l = p.pointNearestToPoint(l).move(s, 1).round(),
            m = f(k, l, p),
            n.points = q ? [l, m, k] : [k, m, l]) : n.points = q ? [l, k] : [k, l],
            n.direction = q ? a(k, d) : a(l, d),
            n
        }
        function m(b, e, f) {
            ...
            for (var q, r = 0, s = b.length - 1; r < s; r++) {
                ...
                if (0 == r)
                    ...
                    w || (t = h(u, v, q));
                t ? (Array.prototype.push.apply(n, t.points),
                q = t.direction) : q = a(u, v),
                r + 1 < s && n.push(v)
            }
            return n
        }
    ...
    joint.routers.manhattan = function(a, b) {
        ...
        function f(a, c, d) {
            var e = d.step
              ...
              , g = b.chain(d.directionMap).pick(c).map(function(b) {
                ...
                return a.containsPoint(g) && g.offset(b.x * e, b.y * e),
                g.snapToGrid(e)
            }).value();
            return g
        }
        ...
        function j(c, j, k, l) {
            ...
            if (c instanceof a.rect ? (m = f(c, l.startDirections, l),
            o = c.center()) : (o = c.clone().snapToGrid(q),
            m = [c]),
            j instanceof a.rect ? (n = f(j, l.endDirections, l),
            p = j.center()) : (p = j.clone().snapToGrid(q),
            n = [j]),
            m = b.filter(m, k.isPointAccessible, k),
            n = b.filter(n, k.isPointAccessible, k),
            m.length > 0 && n.length > 0) {
                ...
                for (var u, v, w = l.directions, x = w.length, y = l.maximumLoops, z = b.invoke(n, "toString"); !r.isEmpty() && y > 0; ) {
                    ...
                    if (z.indexOf(A) >= 0 && (v = h(D, g(B, p, x)),
                    B.equals(p) || v < 180))
                        return l.previousDirAngle = D,
                        e(s, B);
                    for (var E = 0; E < x; E++)
                        if (u = w[E],
                        v = h(D, u.angle),
                        !(v > l.maxAllowedDirectionChange)) {
                            var F = B.clone().offset(u.offsetX, u.offsetY)
                              , G = F.toString();
                            if (!r.isClose(G) && k.isPointAccessible(F)) {
                                var H = C + u.cost + l.penalties[v];
                                (!r.isOpen(G) || H < t[G]) && (s[G] = B,
                                t[G] = H,
                                r.add(G, H + i(F, n)))
                            }
                        }
        ...
        function k(c) {
            c.directions = b.result(c, "directions"),
            c.penalties = b.result(c, "penalties"),
            c.paddingBox = b.result(c, "paddingBox"),
            b.each(c.directions, function(b) {
        ...
        function l(d, e) {
            k(e),
            this.options.perpendicular = !!e.perpendicular;
            for (var f = a.rect(this.sourceBBox).moveAndExpand(e.paddingBox), g = a.rect(this.targetBBox).moveAndExpand(e.paddingBox), h = new c(e).build(this.paper.model, this.model), i = b.map(d, a.point), l = [], m = f.center().snapToGrid(e.step), n = 0, o = i.length; n <= o; n++) {
                var p = null
                  , q = r || f
                  , r = i[n];
                if (!r) {
                ...
                p = p || j(q, r, h, e);
                var u = b.first(p);
                u && u.equals(m) && p.shift(),
                m = b.last(p) || m,
                Array.prototype.push.apply(l, p)
            }
            return l
        }
        var m = {
        ...
        d.prototype.add = function(a, c) {
            this.hash[a] ? this.items.splice(this.items.indexOf(a), 1) : this.hash[a] = this.OPEN,
            this.values[a] = c;
    ...
    joint.routers.oneSide = function(a, b, c) {
        ...
        return k[d] += f * (i[e] / 2 + h),
        l[d] += f * (j[e] / 2 + h),
        f * (k[d] - l[d]) > 0 ? l[d] = k[d] : k[d] = l[d],
        [k].concat(a, l)
    }
    ,
    ...
    joint.connectors.rounded = function(a, b, c, d) {
        ...
        return _.each(c, function(d, n) {
            j = c[n - 1] || a,
            k = c[n + 1] || b,
            h = i || g.point(d).distance(j) / 2,
            i = g.point(d).distance(k) / 2,
            e = g.point(d).move(j, -Math.min(l, h)).round(),
            f = g.point(d).move(k, -Math.min(l, i)).round(),
            m.push(e.x, e.y, "S", d.x, d.y, f.x, f.y, "L")
        }),
        m.push(b.x, b.y),
        m.join(" ")
    }
    ...
    joint.connectors.jumpover = function(a, b) {
        function c(a, c, d) {
            ...
            return e.reduce(function(a, c, d) {
                var f = e[d + 1];
                return null != f && (a[d] = b.line(c, f)),
                a
            }, [])
        }
        function d(a) {
            var b = a.paper._jumpOverUpdateList;
            null == b && (b = a.paper._jumpOverUpdateList = [],
            a.paper.on("cell:pointerup", e),
            a.paper.model.on("reset", function() {
                b = []
            })),
            b.indexOf(a) < 0 && (b.push(a),
            a.listenToOnce(a.model, "change:connector remove", function() {
        ...
        function h(a, c, d) {
            return c.reduce(function(e, f, g) {
                ...
                var p = b.line(i, j);
                return p.isJump = !0,
                e.push(b.line(h.start, i), p, b.line(j, h.end)),
                e
            }, [])
        }
        function i(c, d, e) {
        ...
        return function(b, e, l, n) {
            ...
            var u = this.model
              ...
              , B = z.reduce(function(b, c) {
                ...
                return d.length > 0 ? b.push.apply(b, h(c, d, o)) : b.push(c),
                b
            }, []);
            return i(B, o, p)
        }
    ...
    joint.shapes.pn.PlaceView = joint.dia.ElementView.extend({
        ...
        renderTokens: function() {
            ...
            if (b)
                switch (b) {
                case 1:
                    a[0].className.baseVal += " one",
                    a.append(V("<circle/>").node);
                    break;
                case 2:
                    a[0].className.baseVal += " two",
                    a.append(V("<circle/>").node, V("<circle/>").node);
                    break;
                case 3:
                    a[0].className.baseVal += " three",
                    a.append(V("<circle/>").node, V("<circle/>").node, V("<circle/>").node);
                    break;
                default:
                    a[0].className.baseVal += " alot",
                    a.append(V("<text/>").text(b + "").node)
                }
        }
    }),
    ...
    if ("object" == typeof exports)
        var graphlib = require("graphlib")
          , dagre = require("dagre");
    graphlib = graphlib || "undefined" != typeof window && window.graphlib,
    dagre = dagre || "undefined" != typeof window && window.dagre,
    joint.dia.Graph.prototype.toGraphLib = function(a) {
        ...
        return this.get("cells").each(function(a) {
            if (a.isLink()) {
                ...
                c.setNode(a.id, d(a)),
                c.isCompound() && a.has("parent") && c.setParent(a.id, a.get("parent"))
        }),
        c
    }
    ,
    ...
    joint.shapes.chart.Plot = joint.shapes.basic.Generic.extend({
        ...
        legendPosition: function(a, b) {
            b = b || {},
            this.trigger("batch:start"),
            this.removeAttr([".legend/ref-x", ".legend/ref-y", ".legend/ref-dx", ".legend/ref-dy", ".legend/x-alignment", ".legend/y-alignment"], {
                silent: !0
            });
            var c = b.padding || 10
              , d = {
        ...
        addPoint: function(a, b, c) {
            ...
            f.data.push(a),
            _.isFinite(c.maxLen) && f.data.length > c.maxLen && f.data.shift(),
            d = d.slice(),
            d[e] = f,
            this.set("series", d, c)
        },
    ...
    joint.shapes.chart.PlotView = joint.dia.ElementView.extend({
        ...
        calculateStats: function(a) {
            ...
            _.each(a, function(a, g) {
                ...
                _.each(a.data, function(f) {
                    h.minX = _.isUndefined(h.minX) ? f.x : Math.min(h.minX, f.x),
                    h.maxX = _.isUndefined(h.maxX) ? f.x : Math.max(h.maxX, f.x),
                    h.minY = _.isUndefined(h.minY) ? f.y : Math.min(h.minY, f.y),
                    h.maxY = _.isUndefined(h.maxY) ? f.y : Math.max(h.maxY, f.y),
                    ...
                    _.contains(b, f.x) || b.push(f.x),
                    _.contains(c, f.y) || c.push(f.y),
                    (d[f.x] || (d[f.x] = [])).push({
                        serie: a,
                        x: f.x,
                        y: f.y
            ...
            !this.isEmpty()) {
                ...
                _.each(_.range(n + 1), function(a) {
                    var b = g.scale.linear(h, j, p)
                      , c = this.elTick.clone();
                    c.translate(0, b),
                    V(this.elYAxisTicks).append(c);
                    var d = h[1] - (p - h[0]);
                    d += g.scale.linear(j, h, this.canvas.y) - h[0],
                    c.findOne("text").text(this.tickLabel(d, l)),
                    p += o
                }, this),
                _.each(this.stats.xValues, function(a, d) {
                    if (d % (m.tickStep || 1) === 0) {
        ...
        updateLegend: function() {
            ...
            _.each(a, function(a, b) {
                if ((!_.isFunction(a.showLegend) || a.showLegend(a, this.stats.bySerie[a.name || b])) && a.showLegend !== !1) {
                    ...
                    _.contains(this._disabledSeries, a.name) && c.addClass("disabled"),
        ...
        showGuidelines: function(a, b, c) {
            var d = this.model.get("angle")
              ...
              , f = (this.model.get("series"),
            g.point(V(this.paper.viewport).toLocalPoint(a, b)).rotate(e.center(), d));
    ...
    joint.shapes.chart.Pie = joint.shapes.basic.Generic.extend({
        ...
        editSlice: function(a, b, c, d) {
            ...
            f.data[b] = _.extend(f.data[b], a),
            e = e.slice(),
            e[c] = f,
            this.set("series", e, _.extend(d, {
                changedSerieIndex: c
            }))
        }
    }),
    joint.shapes.chart.PieView = joint.dia.ElementView.extend({
        ...
        update: function(a, b, c) {
            ...
            V(this.elBackgroundRect).attr(e),
            V(this.elForegroundRect).attr(e),
            d.length ? $(this.elBackgroundText).hide() : $(this.elBackgroundText).show(),
        ...
        calculateSeries: function(a) {
            ...
            return this._series = _.map(b, function(b, e) {
                ...
                return b.data = _.map(b.data, function(a, b) {
                    a = _.defaults(a, _.omit(d, "offset", "onClickEffect", "onHoverEffect")),
                    a.outerRadius = i,
                    a.innerRadius = i - j,
                    e || (a = _.defaults(a, _.pick(d, "offset", "onClickEffect", "onHoverEffect")),
                    a.outer = !0,
            ...
            _.each(a, function(a, e) {
                if (a.showLegend) {
                    ...
                    _.each(a.data, function(a, c) {
                        ...
                        V(this.elLegendItems).append(f),
                        _.isObject(g) && this.applyGradient("#" + f.findOne("circle").attr("id"), "fill", g)
                    }, this)
                }
            }, this)
        },
        updateSlice: function(a) {
            ...
            b.append(c),
            _.isObject(d) && this.applyGradient("#" + c.attr("id"), "fill", d);
            ...
            b.append(e),
            _.isObject(d) && this.applyGradient("#" + e.attr("id"), "stroke", d);
        ...
        mouseOverSlice: function(a, b) {
            ...
            c.toggleClass("hover"),
            d.outer && !_.isEmpty(d.onHoverEffect) && this.effectOnSlice(c, d, d.onHoverEffect, !c.hasClass("hover"));
        ...
        clickSlice: function(a, b) {
            ...
            var c = V(this.$('.slice[data-serie="' + b + '"][data-slice="' + a + '"]')[0])
              , d = this._series[b].data[a];
            d.outer && (c.hasClass("clicked") ? (c.removeClass("clicked"),
    ...
    joint.shapes.chart.MatrixView = joint.dia.ElementView.extend({
        ...
        renderMarkup: function() {
            ...
            for (var f = document.createDocumentFragment(), g = 0; g < a.length; g++) {
                ...
                h.attr("d", "M 0 " + g * c + " " + b.width + " " + g * c),
                f.appendChild(h.node);
                for (var i = a[g], j = 0; j < i.length; j++) {
                    if (0 === g) {
                        var h = this.elGridLine.clone();
                        h.addClass("vertical"),
                        h.attr("d", "M " + j * d + " 0 " + j * d + " " + b.height),
                        f.appendChild(h.node)
                    }
                    var k = i[j];
                    if (k) {
            ...
            this.elForeground.appendChild(f),
    ...
    joint.shapes.bpmn.PoolView = joint.dia.ElementView.extend({
        ...
        renderLanes: function(a) {
            ...
            this.$lanes.empty(),
            a.sublanes && this.renderSublanes(a.sublanes, 0, 0, 1),
        ...
        renderSublanes: function(a, b, c, d) {
            ...
            _.each(a, function(a, d) {
                var g = "lane" + this.index
                  ...
                  , j = "." + g + " .lane-label";
                a.name && (g += " " + a.name),
                this.$lanes.append(this.laneMarkup.clone().addClass(g).node);
                var k = b + e
                  , l = c + f * d;
                this.lanesAttrs[h] = {
                    ref: ".body",
                ...
                this.index++,
                a.sublanes && this.renderSublanes(a.sublanes, k, l, f)
            }, this)
        }
    }),
    ...
    joint.shapes.bpmn.ChoreographyView = joint.shapes.basic.TextBlockView.extend({
        ...
        update: function() {
            return _.isUndefined(this.participantsAttrs) ? this.renderParticipants(this.model.get("participants")) : (this.layoutAndUpdate(),
            this)
        },
        renderMarkup: function() {
            joint.dia.ElementView.prototype.renderMarkup.apply(this, arguments),
    ...
    joint.dia.CommandManager = Backbone.Model.extend({
        ...
        addCommand: function(a, b, c, d) {
            if ((!d || !d.dry) && this.get("cmdNameRegex").test(a) && ("function" != typeof this.get("cmdBeforeAdd") || this.get("cmdBeforeAdd").apply(this, arguments))) {
                ...
                if (this.batchCommand) {
                    if (e = this.batchCommand[Math.max(this.lastCmdIndex, 0)],
                    this.lastCmdIndex >= 0 && (e.data.id !== b.id || e.action !== a)) {
                        var f = _.findIndex(this.batchCommand, function(c, d) {
                            return c.data.id === b.id && c.action === a
                        }, this);
                        f < 0 || "add" === a || "remove" === a ? e = this.createCommand({
                            batch: !0
                        }) : (e = this.batchCommand[f],
                        this.batchCommand.splice(f, 1)),
                ...
                e.data.id = b.id,
                e.data.type = b.attributes.type,
                e.data.previous[g] = _.clone(b.previous(g)),
                e.options = d || {}),
                e.data.next[g] = _.clone(b.get(g)),
                this.push(e)
            }
        },
        ...
        undo: function() {
            ...
            a && (this.revertCommand(a),
            this.redoStack.push(a))
        },
        redo: function() {
            var a = this.redoStack.pop();
            a && (this.applyCommand(a),
            this.undoStack.push(a))
        },
        cancel: function() {
            this.hasUndo() && (this.revertCommand(this.undoStack.pop()),
            this.redoStack = [])
        },
        reset: function() {
            this.undoStack = [],
    ...
    joint.ui.PaperScroller = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            this._sx = b.sx,
            this._sy = b.sy,
            _.isUndefined(this.options.baseWidth) && (this.options.baseWidth = a.options.width),
            _.isUndefined(this.options.baseHeight) && (this.options.baseHeight = a.options.height),
            this.$el.append(a.el),
            this.addPadding(),
            this.listenTo(a, "scale", this.onScale),
        ...
        adjustPaper: function() {
            ...
            return this.options.paper.fitToContent(this.transformContentOptions(a)),
            this
        },
        ...
        center: function(a, b, c) {
            ...
            _.isUndefined(a) || _.isUndefined(b) ? (a = (e + g) / 2,
            b = (f + h) / 2) : (a *= d.a,
            b *= d.d);
            ...
            this.scroll(a, b, _.isUndefined(c) ? a || null : c),
            this
        },
        ...
        addPadding: function(a, b, c, d) {
            ...
            return f.paddingLeft = Math.min(f.paddingLeft, .9 * this.el.clientWidth),
            f.paddingTop = Math.min(f.paddingTop, .9 * this.el.clientHeight),
            this.$el.css(f),
        ...
        zoom: function(a, b) {
            ...
            if (b.absolute || (f += this._sx,
            g += this._sy),
            b.grid && (f = Math.round(f / b.grid) * b.grid,
            g = Math.round(g / b.grid) * b.grid),
            b.max && (f = Math.min(b.max, f),
            g = Math.min(b.max, g)),
            b.min && (f = Math.max(b.min, f),
            g = Math.max(b.min, g)),
            _.isUndefined(b.ox) || _.isUndefined(b.oy))
                c = e.x,
                d = e.y;
            else {
                var h = f / this._sx
        ...
        getVisibleArea: function() {
            ...
            return c.x -= (this.padding.paddingLeft || 0) / this._sx,
            c.y -= (this.padding.paddingTop || 0) / this._sy,
            c
        },
        isElementVisible: function(a) {
            return this.checkElement(a, "isElementVisible"),
            this.getVisibleArea().containsRect(a.getBBox())
        },
    ...
    joint.ui.SelectionView = joint.mvc.View.extend({
        ...
        init: function() {
            if (this.model = this.model || this.options.model || new Backbone.Collection,
            !this.options.paper)
            ...
            this.listenTo(this.options.graph, "remove change", function(a, b) {
        ...
        startTranslatingSelection: function(a) {
            ...
            this.trigger("selection-box:pointerdown", a)
        },
        startSelecting: function(a) {
            ...
            var b = a.target.parentElement || a.target.parentNode
              ...
              , d = b.scrollLeft
              , e = b.scrollTop;
            this._offsetX = void 0 === a.offsetX ? a.clientX - c.left + window.pageXOffset + d : a.offsetX,
            this._offsetY = void 0 === a.offsetY ? a.clientY - c.top + window.pageYOffset + e : a.offsetY,
            this.$el.css({
                width: 1,
                height: 1,
                left: this._offsetX,
        ...
        adjustSelection: function(a) {
            ...
            case "translating":
                var f = this.options.paper.snapToGrid(g.point(a.clientX, a.clientY))
                  , h = f.x
                  , i = f.y;
                if (b = h - this._snappedClientX,
                c = i - this._snappedClientY,
                b || c) {
                    var j = {};
                    if (this.model.each(function(a) {
                        if (!j[a.id]) {
                            var d = {};
                            d["selectionView_" + this.cid] = !0,
                            a.translate(b, c, d),
                            _.each(a.getEmbeddedCells({
                                deep: !0
                            }), function(a) {
                                j[a.id] = !0
                            });
                    ...
                    this._snappedClientX = h,
                    this._snappedClientY = i
                }
        ...
        stopSelecting: function(a) {
            ...
            case "selecting":
                ...
                j.length ? (_.each(j, this.createSelectionBox, this),
                this.$el.addClass("selected")) : this.$el.hide();
                break;
            case "translating":
                this.options.graph.trigger("batch:stop"),
                this.trigger("selection-box:pointerup", a);
                break;
            default:
        ...
        destroySelectionBox: function(a) {
            this.$('[data-model="' + a.model.get("id") + '"]').remove(),
            0 === this.$el.children(".selection-box").length && this.$el.hide().removeClass("selected"),
        ...
        doRotate: function(a, b, c, d, e) {
            var f = this._rotation
              , h = this.options.rotateAngleGrid
              , i = this.options.paper.snapToGrid({
                x: a.clientX,
                y: a.clientY
            })
              , j = f.clientAngle - g.point(i).theta(f.center);
            this.model.each(function(a) {
                var b = g.snapToGrid(f.initialAngles[a.id] + j, h);
                a.rotate(b, !0, f.center)
            })
        },
        stopBatch: function() {
            this.options.graph.trigger("batch:stop")
    ...
    joint.ui.Clipboard = Backbone.Collection.extend({
        ...
        copyElements: function(a, b, c) {
            c = c || {};
            var d = b.cloneSubgraph(a.models, c)
              , e = []
              , f = []
              , g = [];
            return _.each(d, function(a, d) {
                a.isLink() ? (c.translate && _.each(a.get("vertices"), function(a) {
                    a.x += c.translate.dx || 20,
                    a.y += c.translate.dy || 20
                }),
                g.push(a)) : (c.translate && a.translate(c.translate.dx || 20, c.translate.dy || 20),
                f.push(a)),
                e.push(b.getCell(d))
            }),
            this.reset(f.concat(g)),
        ...
        pasteCells: function(a, b) {
            ...
            a.trigger("batch:start"),
            this.each(function(c) {
                c.unset("z"),
                c instanceof joint.dia.Link && b.link && c.set(b.link),
                a.addCell(c.toJSON())
            }),
    ...
    joint.ui.Halo = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            this.options.clearAll && joint.ui.Halo.clear(this.options.paper),
        ...
        render: function() {
            ...
            this.$pieToggles = {},
            this.$el.addClass(a.type),
            this.$el.attr("data-type", a.cellView.model.get("type")),
            ...
            case "pie":
                _.each(this.options.pieToggles, function(a) {
                    var b = $("<div/>");
                    b.addClass("pie-toggle " + (a.position || "e")),
                    b.attr("data-name", a.name),
                    joint.util.setAttributesBySelector(b, a.attrs),
                    b.appendTo(this.el),
                    this.$pieToggles[a.name] = b
                }, this);
                break;
            default:
        ...
        update: function() {
            ...
            if (!(a.model instanceof joint.dia.Link)) {
                ...
                this.$el.toggleClass("tiny", b.width < this.options.tinyThreshold && b.height < this.options.tinyThreshold),
                this.$el.toggleClass("small", !this.$el.hasClass("tiny") && b.width < this.options.smallThreshold && b.height < this.options.smallThreshold),
                this.$el.css({
                    width: b.width,
                    height: b.height,
                    left: b.x,
        ...
        addHandles: function(a) {
            return _.each(a, this.addHandle, this),
            this
        },
        addHandle: function(a) {
            var b = this.getHandle(a.name);
            if (!b && (this.handles.push(a),
            _.each(a.events, function(b, c) {
                _.isString(b) ? this.on("action:" + a.name + ":" + c, this[b], this) : this.on("action:" + a.name + ":" + c, b)
            }, this),
            this.$handles)) {
        ...
        renderHandle: function(a) {
            ...
            case "pie":
                var d = this.PIE_OUTER_RADIUS
                  ...
                  , n = V("path").attr("d", l).translate(d, d).addClass("slice")
            ...
            return a.icon && this.setHandleIcon(c, a.icon),
            joint.util.setAttributesBySelector(c, a.attrs),
            c
        },
        ...
        toggleHandle: function(a, b) {
            ...
            if (c) {
                var d = this.$(".handle." + a);
                _.isUndefined(b) && (b = !d.hasClass("selected")),
        ...
        deselectAllHandles: function() {
            return _.chain(this.handles).pluck("name").each(this.deselectHandle, this).value(),
            this
        },
        onHandlePointerDown: function(a) {
            this._action = $(a.target).closest(".handle").attr("data-action"),
        ...
        startCloning: function(a) {
            ...
            this._cloneView = c.findView(b.paper),
            this._cloneView.pointerdown(a, this._clientX, this._clientY)
        },
        startLinking: function(a) {
            ...
            d.attr(this.options.linkAttributes),
            _.isBoolean(this.options.smoothLinks) && d.set("smooth", this.options.smoothLinks),
            this.options.graph.addCell(d, {
                validation: !1,
                halo: this.cid,
                async: !1
            }),
            ...
            this._linkView = this.options.paper.findViewByModel(d),
        ...
        startForking: function(a) {
            ...
            d.attr(b.linkAttributes),
            _.isBoolean(b.smoothLinks) && d.set("smooth", b.smoothLinks),
            b.graph.addCells([c, d], {
                halo: this.cid,
                async: !1
            }),
            this._cloneView = c.findView(b.paper),
        ...
        startRotating: function(a) {
            ...
            this._center = b,
            this._rotationStartAngle = c || 0,
            this._clientStartAngle = g.point(d).theta(b)
        },
        ...
        stopForking: function(a) {
            this._cloneView.pointerup(a, this._clientX, this._clientY),
            this.stopBatch()
        },
        ...
        toggleState: function(a) {
            ...
            this.isOpen())
                this.trigger("state:close", a),
                b.removeClass("open");
            else {
                if (this.trigger("state:open", a),
                a) {
        ...
        makeLoopLink: function(a) {
            var b, c, d = this.options.loopLinkWidth, e = this.options.paper.options, f = g.rect({
                ...
                switch (a) {
                case "top":
                    e = g.point(h.x + h.width / 2, h.y - d),
                    i = d / 2;
                    break;
                case "bottom":
                    e = g.point(h.x + h.width / 2, h.y + h.height + d),
                    i = d / 2;
                    break;
                case "left":
                    e = g.point(h.x - d, h.y + h.height / 2),
                    j = d / 2;
                    break;
                case "right":
                    e = g.point(h.x + h.width + d, h.y + h.height / 2),
                    j = d / 2
                }
                return b = g.point(e).offset(-i, -j),
                c = g.point(e).offset(i, j),
                f.containsPoint(b) && f.containsPoint(c)
            }, this);
    ...
    joint.ui.Stencil = joint.mvc.View.extend({
        ...
        setPaper: function(a) {
            ...
            if (a instanceof joint.dia.Paper)
                ...
                b.paperScroller = a,
                b.paper = a.options.paper,
                b.graph = a.options.paper.model
            }
        },
        ...
        render: function() {
            ...
            if (this.options.groups) {
                ...
                this.graphs.__default__ = d,
                this.papers.__default__ = e
            }
        ...
        onDrag: function(a) {
            if (this._clone) {
                ...
                this.options.paper.options.embeddingMode && this._cloneView) {
                    ...
                    e.x += this._clonePosition.x,
                    e.y += this._clonePosition.y,
                    this._clone.set("position", e, {
                        silent: !0
                    }),
        ...
        onDragEnd: function(a) {
            if (this._clone && this._cloneBbox) {
                a = joint.util.normalizeEvent(a),
                this._clone.set("position", this._clonePosition, {
                    silent: !0
                });
                var b = this._clone.clone()
                  , c = this.drop(a, b, this._cloneBbox);
                if (c || this.trigger("drop:invalid", a, b),
                !c && this.options.dropAnimation) {
                    ...
                    var f = e.findViewByModel(d)
                      , g = !a || _.some(b, function(b, e) {
                        ...
                        var f = _.some(b, function(b) {
                            ...
                            return !_.isUndefined(e) && !_.isNull(e) && (e = e.toString(),
                            c && (e = e.toLowerCase()),
                            e.indexOf(a) >= 0)
                        });
                        return f
    ...
    joint.ui.Inspector = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            this.widgets = [],
            this.flatAttributes = joint.util.flattenObject(this.options.inputs, "/", function(a) {
                return a.type
            }),
            this._when = {},
            this._bound = {};
            var a = _.map(this.flatAttributes, function(a, b) {
                ...
                return "select" == a.type && _.isString(a.options) && (this._bound[b] = a.options),
                a.path = b,
                a
            }, this);
            ...
            this.on("render", function() {
                ...
                _.each(this.$("[data-attribute]"), function(c) {
                    ...
                    a[e] = d,
                    b.push(e.substring(0, e.indexOf("/")) || e)
                }, this),
                this._byPath = a,
                this._attributeKeys = _.uniq(b),
                _.each(this.$groups, function(a) {
                    var b = $(a)
        ...
        render: function() {
            ...
            return _.each(this.groupedFlatAttributes, function(d) {
                ...
                this.renderTemplate(b, d, d.path),
                a = d.group
            }, this),
            this.$groups = c,
            this.$el.append(c),
        ...
        getCellAttributeValue: function(a, b) {
            ...
            if (b = b || this.flatAttributes[a],
            !b)
                return d;
            if (_.isUndefined(d) && !_.isUndefined(b.defaultValue) && (d = b.defaultValue),
            b.valueRegExp) {
                if (_.isUndefined(d))
        ...
        resolveBindings: function(a) {
            ...
            case "select":
                var b = a.options || [];
                _.isString(b) && (b = joint.util.getByPath(this.getModel().attributes, b, "/") || []),
                _.isObject(b[0]) || (b = _.map(b, function(a) {
                    return {
                        value: a,
                        content: a
                    }
        ...
        renderFieldContent: function(a, b, c) {
            ...
            case "select-box":
                f = _.findIndex(a.options, function(a) {
                    return a.value === c || !(!_.isUndefined(a.value) || a.content !== c)
                }),
                ...
                d = $("<div/>").append(h, e.el),
                a.previewMode ? (g = e.selection,
                e.on("options:mouseout close", function() {
                    e.selection = g,
                ...
                e.on("option:hover", function(a, b) {
                    e.selection = a,
                    this.processInput(e.$el, {
                        dry: !0
                    })
                }, this),
                e.on("option:select", function(a, b) {
            ...
            case "select-button-group":
                ...
                e.on("option:hover", function(b, c) {
                    a.multi ? e.selection = _.uniq(e.selection.concat([b])) : e.selection = b,
                    this.processInput(e.$el, {
                        dry: !0
                    })
                }, this),
        ...
        renderOwnFieldContent: function(a) {
            ...
            case "number":
                ...
                break;
            case "range":
                i.addClass("with-output"),
                e = $("<output/>").text(a.value),
                f = $("<span/>").addClass("units").text(a.options.unit),
                c = $("<input/>", {
                    type: "range",
                    name: a.type,
                    min: a.options.min,
                ...
                break;
            case "textarea":
                c = $("<textarea/>").text(a.value),
                b = [i, c];
                break;
            case "select":
                var j = a.options.items;
                c = $("<select/>"),
                a.options.multiple && c.prop({
                    size: a.options.size || j.length,
                    multiple: !0
                }),
                _.each(j, function(b) {
                    var d = $("<option/>", {
                    ...
                    (b.value === a.value || _.contains(a.value, b.value)) && d.attr("selected", "selected"),
                    c.append(d)
                }),
                b = [i, c];
                break;
            ...
            case "object":
                c = $("<div/>"),
                h = $("<div/>").addClass("object-properties"),
                b = [i, c.append(h)];
                break;
            case "list":
                g = $("<button/>").addClass("btn-list-add").text(a.options.addButtonLabel || "+"),
                h = $("<div/>").addClass("list-items"),
                c = $("<div/>"),
                b = [i, c.append(g, h)]
            }
        ...
        renderTemplate: function(a, b, c, d) {
            a = a || this.$el,
            d = d || {},
            this.resolveBindings(b);
            var e = this.renderFieldContainer({
                path: c
            });
            b.when && !this.isExpressionValid(b.when) && (e.addClass("hidden"),
            b.when.otherwise && b.when.otherwise.unset && this.unsetProperty(c));
            var f = this.getCellAttributeValue(c, b)
              , g = this.renderFieldContent(b, c, f);
            if (e.append(g),
            joint.util.setAttributesBySelector(e, b.attrs),
            "list" === b.type)
                _.each(f, function(a, d) {
                    ...
                    this.renderTemplate(e, b.item, c + "/" + d),
                    g.children(".list-items").append(e)
                }, this);
                ...
                _.each(h, function(a) {
                    ...
                    this.renderTemplate(b, a, c + "/" + a.path),
                    g.children(".object-properties").append(b)
                }, this)
            }
        ...
        unsetProperty: function(a, b) {
            var c = this.getModel()
              ...
              , f = d.slice(1).join("/");
            if (b = b || {},
            b.inspector = this.cid,
            b["inspector_" + this.cid] = !0,
            "attrs" == a)
                c.removeAttr(f, b);
            else if (a == e)
                c.unset(e, b);
        ...
        updateCell: function(a, b, c) {
            ...
            _.each(e, function(a, b) {
                if (!a.closest(".field").hasClass("hidden")) {
                    ...
                    switch (g) {
                    case "list":
                        f = this.findParentListByPath(b),
                        f ? (e = b.substr(f.length + 1),
                        joint.util.setByPath(this._tempListsByPath[f], e, [], "/")) : this._tempListsByPath[b] = [];
                        break;
                    case "object":
                        break;
                    default:
                        ...
                        if (f = this.findParentListByPath(b),
                        f && this._tempListsByPath[f])
                            return e = b.substr(f.length + 1),
                            void joint.util.setByPath(this._tempListsByPath[f], e, i, "/");
                        this.setProperty(b, i, c),
                        this.updateBindings(b)
                    }
                }
            }, this),
            _.each(this._tempListsByPath, function(a, b) {
        ...
        addListItem: function(a) {
            ...
            this.renderTemplate(i, e.item, d + "/" + h),
            b.parent().children(".list-items").append(i),
        ...
        closeGroup: function(a, b) {
            ...
            !b.init && c.hasClass("closed") || (c.addClass("closed"),
            this.trigger("group:close", c.data("name"), b))
        },
        openGroup: function(a, b) {
            b = b || {};
            var c = _.isString(a) ? this.$('.group[data-name="' + a + '"]') : $(a);
            (b.init || c.hasClass("closed")) && (c.removeClass("closed"),
            this.trigger("group:open", c.data("name"), b))
        },
        closeGroups: function() {
        ...
        isExpressionValid: function(a) {
            return a = _.omit(a, "otherwise", "dependencies"),
            this._evalExpression(a)
        },
        extractExpressionPaths: function(a) {
            var b = a && a.dependencies || [];
            return a = _.omit(a, "otherwise", "dependencies"),
            _.uniq(this._extractVariables(a).concat(b))
        }
    });
        ...
        pointermove: function(a) {
            if (this._action) {
                ...
                case "resize":
                    ...
                    if (j = g.snapToGrid(j, c),
                    k = g.snapToGrid(k, c),
                    j = Math.max(j, this.options.minWidth || c),
                    k = Math.max(k, this.options.minHeight || c),
                    j = Math.min(j, this.options.maxWidth),
                    k = Math.min(k, this.options.maxHeight),
    ...
    joint.ui.Tooltip = joint.mvc.View.extend({
        ...
        render: function(a) {
            ...
            c ? b = a : (this.$target = $(a.target).closest(this.options.target),
            b = this.$target[0]),
            this.$(".tooltip-content").html(_.isFunction(this.options.content) ? this.options.content(b) : this.options.content),
            this.$el.hide(),
            $(document.body).append(this.$el);
            var d = this.$("img");
            d.length ? d.on("load", _.bind(function() {
                this.position(c ? b : void 0)
            }, this)) : this.position(c ? b : void 0),
        ...
        position: function(a) {
            ...
            var m = {};
            this.options.left || this.options.right ? m.top = b.y + b.height / 2 - d.top : this.options.top || this.options.bottom ? m.left = b.x + b.width / 2 - d.left : m.top = b.y + b.height / 2 - d.top,
            this.$el.css(_.pick(d, "top", "left")),
            this.$(".tooltip-arrow, .tooltip-arrow-mask").css(m)
        },
        respectViewport: function(a) {
            ...
            var b = joint.util.getElementBBox(this.options.viewport.selector || "html")
              ...
              , e = $(window);
            return this.options.viewport.selector || (b.width = e.width() + e.scrollLeft(),
            b.height = e.height() + e.scrollTop()),
            b.top = b.y - d,
            b.left = b.x - c,
            b.right = b.left + b.width,
            b.bottom = b.top + b.height,
            a.left < b.left ? a.left = a.x = b.left + this.options.viewport.padding : a.right > b.right && (a.left = a.x = b.right - this.options.viewport.padding - a.width),
            a.top < b.top ? a.top = a.y = b.top + this.options.viewport.padding : a.bottom > b.bottom && (a.top = a.y = b.bottom - this.options.viewport.padding - a.height),
            a
        }
    });
    joint.ui.Snaplines = joint.mvc.View.extend({
        ...
        startListening: function() {
            ...
            _.isArray(this.options.filter) ? _.each(this.options.filter, function(a) {
        ...
        onBatchStop: function(a) {
            a = a || {},
            "resize" === a.batchName && this.snapWhileResizing(a.element, a)
        },
        ...
        snapWhileResizing: function(a, b) {
            if (b.ui && !b.snapped && b.direction && b.trueDirection) {
                ...
                if (!(c instanceof joint.dia.LinkView)) {
                    ...
                    if (b.trueDirection.indexOf("right") !== -1 ? m.vertical = h.x : m.vertical = f.x,
                    b.trueDirection.indexOf("bottom") !== -1 ? m.horizontal = h.y : m.horizontal = f.y,
                    _.find(this.options.paper.model.getElements(), function(b) {
                        ...
                        _.isNull(k) && f.vertical.length > 0 && (k = f.vertical[0].position),
                        _.isNull(l) && f.horizontal.length > 0 && (l = f.horizontal[0].position),
                        _.isNumber(k) && _.isNumber(l)
                    }, this),
                    this.hide(),
                    _.isNumber(k) || _.isNumber(l)) {
                        var n = 0;
                        _.isNumber(k) && (n = b.trueDirection.indexOf("right") !== -1 ? k - e.corner().x : e.origin().x - k);
                        var o = 0;
                        _.isNumber(l) && (o = b.trueDirection.indexOf("bottom") !== -1 ? l - e.corner().y : e.origin().y - l);
                        var p, q = 0, r = 0, s = i % 90, t = !(i % 90);
                        if (p = i >= 0 && i < 90 ? 1 : i >= 90 && i < 180 ? 4 : i >= 180 && i < 270 ? 3 : 2,
                        t)
                            90 === i || 270 === i ? (q = o,
                            r = n) : (q = n,
                            r = o);
                            ...
                            l = null ) : (n = 0,
                            k = null )),
                            n && (q = 3 === p ? n / Math.cos(u) : n / Math.sin(u)),
                            o && (r = 3 === p ? o / Math.cos(u) : o / Math.sin(u));
                            var v = 1 === p || 3 === p;
    ...
    joint.ui.TextEditor = joint.mvc.View.extend({
        ...
        annotateURLBeforeCaret: function(a) {
            ...
            if (b) {
                ...
                return c = this.annotateURL(c || [], b[0], b[1]),
                !0
            }
            return !1
        },
        ...
        select: function(a, b) {
            ...
            _.isUndefined(b) && (b = a),
            _.isNumber(a) && (this.selection.start = a),
            _.isNumber(b) && (this.selection.end = b),
            _.isNumber(this.selection.end) || (this.selection.end = this.selection.start),
            _.isNumber(this.selection.start) && _.isNumber(this.selection.end) && (this.selection.start === this.selection.end ? (this.clearSelection(),
            this.focus(),
        ...
        selectTextInElement: function(a, b, c) {
            if (_.isFunction(a.selectSubString) && this.selectTextInElementUsingSelectSubString(a, b, c),
            !this.actualSelectionMatchesExpectedSelection(b, c))
                try {
                    ...
                    _.isFunction(a.selectSubString) && this.selectTextInElementUsingSelectSubString(a, b, c)
                }
        },
        ...
        normalizeSelectionRange: function(a) {
            var a = _.clone(a);
            return a.start > a.end && (a.end = [a.start, a.start = a.end][0]),
            a
        },
        ...
        edit: function(a, b) {
            ...
            this.close(),
            this.ed = new joint.ui.TextEditor(_.extend({
                text: d
            }, b)),
    ...
    joint.ui.Dialog = joint.mvc.View.extend({
        ...
        render: function() {
            ...
            return this.$el.toggleClass("draggable", !!this.options.draggable),
            ...
            this.options.buttons && _.each(this.options.buttons.reverse(), function(a) {
                var b = $("<button/>", {
                    "class": "control-button",
                    html: a.content,
                    "data-action": a.action
                });
                a.position && b.addClass(a.position),
                f.append(b)
            }),
            b.append(c, d, f),
    ...
    joint.ui.FlashMessage = joint.ui.Dialog.extend({
        ...
        open: function(a, b, c) {
            return c = c || {},
            new joint.ui.FlashMessage(_.extend({
                title: b,
                type: "info",
                content: a
            }, c)).open(c.target)
    ...
    joint.ui.Lightbox = joint.ui.Dialog.extend({
        ...
        init: function() {
            ...
            joint.ui.Dialog.prototype.init.apply(this, arguments),
            this.options.image && (this.$image = $("<img/>", {
    ...
    joint.ui.ContextToolbar = joint.mvc.View.extend({
        ...
        position: function() {
            var a = ($(this.options.target),
            joint.util.getElementBBox(this.options.target))
    ...
    joint.ui.SelectBox = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            this.options.keyboardNavigation && $(document).on("keydown.selectBox", this.onKeydown),
            this.$el.data("view", this),
            _.isUndefined(this.options.selected) ? this.selection = _.findWhere(this.options.options, {
                selected: !0
        ...
        renderOptions: function() {
            this.removeOptions(),
            this.$options = $("<div/>", {
                "class": [this.className, "select-box-options"].join(" ")
            }),
            ...
            this.options.width && this.$options.css("width", this.options.width),
            _.each(this.options.options, function(a, b) {
                var c = this.renderOption(a, b);
                this.$options.append(c),
                this.selection === a && c.addClass("selected hover")
            }, this),
        ...
        markOptionHover: function(a) {
            ...
            $(this.$options.find(".select-box-option")[a]).addClass("hover")
        },
        onOptionHover: function(a) {
            var b = this.getOptionIndex(a.target);
            this.markOptionHover(b),
        ...
        getSelectionValue: function(a) {
            ...
            a && (_.isUndefined(a.value) ? a.content : a.value)
        },
        ...
        onRemove: function() {
            ...
            this.options.keyboardNavigation && $(document).off(".selectBox", this.onKeydown)
        },
        onKeydown: function(a) {
            if (this.isOpen()) {
                var b;
                ...
                e < 0 && (e = f.length - 1),
                e >= f.length && (e = 0),
                this.markOptionHover(e),
                this.trigger("option:hover", this.options.options[e], e)
            }
        },
        isDisabled: function() {
    ...
    joint.ui.SelectButtonGroup = joint.mvc.View.extend({
        ...
        getSelectionValue: function(a) {
            if (a = a || this.selection)
                return this.options.multi ? _.map(a, function(a) {
        ...
        select: function(a, b) {
            ...
            if (e) {
                ...
                f ? this.selection.indexOf(c) === -1 && this.selection.push(c) : this.selection = _.without(this.selection, c),
    ...
    joint.ui.Navigator = joint.mvc.View.extend({
        ...
        render: function() {
            return this.targetPaper.$el.appendTo(this.el),
    ...
    joint.ui.TreeLayoutView = joint.mvc.View.extend({
        ...
        toggleDefaultInteraction: function(a) {
            var b = this.options.paper;
            b.options.interactive = a,
            _.chain(b.model.getElements()).map(b.findViewByModel, b).each(function(b) {
        ...
        _finishDrag: function(a, b, c) {
            ...
            this.candidate ? (_.each(a, _.partial(this.reconnectElement, _, this.candidate), this),
            this.candidate = null ,
            this.model.layout({
                ui: !0
            })) : this.canDrop() && (_.each(a, _.partial(this.translateElement, _, b, c), this),
            this.model.layout({
                ui: !0
            })),
        ...
        startDragging: function(a, b, c) {
            ...
            _.isEmpty(d) || (this._registerPointerEvents(),
            this._moveCounter = 0,
            this._draggedElements = d)
        },
    ...
    joint.layout.ForceDirected = Backbone.Model.extend({
        ...
        step: function() {
            ...
            for (h += this.elements[l - 1].x,
            i += this.elements[l - 1].y,
            f = 0; f < m; f++) {
                var w = this.links[f]
                  , n = w.source
                  , o = w.target
    ...
    !function(a, b, c, d) {
        function e(a, b, d) {
            ...
            this.width = 0,
            this.height = 0,
            this.layoutAreas = this.sortLayoutAreas(a),
            this.parentArea = b,
        ...
        function f(a, b, d) {
            ...
            this.root = a,
            this.childAreas = b,
            this.siblingRank = e.siblingRank,
            this.rootOffset = e.rootOffset,
            this.gap = e.gap,
            this.dx = 0,
            this.dy = 0,
            this.width = 0,
            this.height = 0,
            c.invoke(b, "addParentReference", this),
            this.computeRelativePosition(a, b, e)
        }
        ...
        var g = e.extend({
          ...
          , j = e.extend({
            ...
            computeSize: function(a) {
                this.width = c.sum(this.layoutAreas, "width") + this.sumGaps(a.siblingGap),
                c.reduce(this.layoutAreas, function(b, c) {
                    return this.height = Math.max(this.height, c.getExtendedHeight()),
                    c.dx += b + c.width / 2,
                    b + c.width + a.siblingGap
                }, -this.width / 2, this)
            },
            getNeighborPointFromRank: function(a) {
                var b;
        ...
        c.extend(f.prototype, {
            ...
            findMinimalAreaByPoint: function(a, b) {
                ...
                return c.some(this.childAreas, function(c) {
                    return d = c.findMinimalAreaByPoint(a, b),
                    !!d
                }),
                d || this
            },
            ...
            getRootSize: function(a, b) {
                ...
                return d[this.marginDimension] += b,
                d
            },
            ...
            computeRelativePosition: function(a, b, d) {
                ...
                c.extend(this, this.computeSize(e, f)),
                this.moveSiblings(e, f),
                this.moveRootToConnectionPoint(f),
                this.moveRootBehindSiblings(e, f),
                this.moveRootFromParent(d.gap + d.rootOffset)
            },
            ...
            getRootVertices: function(a, b) {
                if (b = b || {},
                a = a || this,
                0 === a[this.deltaCoordinate] || !this.parentArea)
                    return [];
        ...
        var m = f.extend({
          ...
          , o = n.extend({
            ...
            moveRootBehindSiblings: function(a, b) {
                this.dx += Math.max(a.L.width, (a.T.width - b.width) / 2, (a.B.width - b.width) / 2),
                this.dy += (a.T.height - a.B.height) / 2
            },
          ...
          , p = n.extend({
            ...
            moveRootBehindSiblings: function(a, b) {
                this.dx -= Math.max(a.R.width, (a.T.width - b.width) / 2, (a.B.width - b.width) / 2),
                this.dy += (a.T.height - a.B.height) / 2
            },
            moveRootFromParent: function(a) {
                this.dx -= a
          ...
          , t = b.Model.extend({
            ...
            layout: function(a) {
                ...
                c.each(this.graph.getSources(), c.partial(this.layoutTree, c, a), this),
                this.trigger("layout:done", a),
                this
            },
            ...
            _computeAbsolutePositions: function(a) {
                ...
                c.each(a.childAreas, this._computeAbsolutePositions, this)
            },
            _updateCells: function(a, b) {
                var d = a.root
                  , e = a.link || null ;
                e && (this.updatePosition && this.updatePosition(d, a.getRootPosition(), b),
                this.updateVertices && this.updateVertices(e, a.getRootVertices(), b)),
                this.changeSiblingRank(d, a.siblingRank, b),
                this.updateAttributes && this.updateAttributes(a, d, e, b),
                c.each(a.childAreas, c.partial(this._updateCells, c, b), this)
            },
    ...
    joint.dia.Paper.prototype.toSVG = function(a, b) {
        function c() {
            return (new XMLSerializer).serializeToString(g).replace(/&nbsp;/g, " ")
        }
        function d(a) {
            var b = V(m.shift());
            if (!b)
        ...
        V(this.viewport).attr("transform", e || ""),
        g.removeAttribute("style"),
        b.preserveDimensions ? V(g).attr({
            width: f.width,
            height: f.height
        }) : V(g).attr({
            width: "100%",
        ...
        for (var h = document.styleSheets.length, i = [], j = h - 1; j >= 0; j--)
            i[j] = document.styleSheets[j],
            document.styleSheets[j].disabled = !0;
        var k = {};
        ...
        return $(g).find("*").each(function(a) {
            $(this).css(l[a]),
            "image" === this.tagName.toLowerCase() && m.push(this)
        }),
    ...
    function stackBlurImage(a, b, c, d) {
        ...
        i.clearRect(0, 0, f, g),
        i.drawImage(e, 0, 0),
        isNaN(c) || c < 1 || (d ? stackBlurCanvasRGBA(b, 0, 0, f, g, c) : stackBlurCanvasRGB(b, 0, 0, f, g, c))
    }
        ...
        if (!(isNaN(f) || f < 1)) {
            ...
            for (l = 0; l < e; l++) {
                ...
                k = 0; k < d; k++)
                    ...
                    I[p] = (r * T >> U) * G,
                    I[p + 1] = (s * T >> U) * G,
                    I[p + 2] = (t * T >> U) * G) : I[p] = I[p + 1] = I[p + 2] = 0,
                    r -= v,
                    s -= w,
                    t -= x,
                    u -= y,
            ...
            for (k = 0; k < d; k++) {
                ...
                l = 0; l < e; l++)
                    ...
                    I[n] = (r * T >> U) * G,
                    I[n + 1] = (s * T >> U) * G,
                    I[n + 2] = (t * T >> U) * G) : I[n] = I[n + 1] = I[n + 2] = 0,
                    r -= v,
                    s -= w,
                    t -= x,
                    u -= y,
    ...
    !function() {
        function a() {
            ...
            a.Font = new function() {
                ...
                this.Parse = function(c) {
                    for (var d = {}, e = a.trim(a.compressSpaces(c || "")).split(" "), f = {
                        ...
                        f.fontStyle || b.Styles.indexOf(e[h]) == -1 ? f.fontVariant || b.Variants.indexOf(e[h]) == -1 ? f.fontWeight || b.Weights.indexOf(e[h]) == -1 ? f.fontSize ? "inherit" != e[h] && (g += e[h]) : ("inherit" != e[h] && (d.fontSize = e[h].split("/")[0]),
            ...
            a.Element.pattern = function(b) {
                this.base = a.Element.ElementBase,
                this.base(b),
                this.createPattern = function(b, c) {
                    ...
                    f.attributes.height = new a.Property("height",e + "px"),
                    ...
                    for (var i = -1; i <= 1; i++)
                        for (var j = -1; j <= 1; j++)
                            h.save(),
                            h.translate(i * g.width, j * g.height),
                            f.render(h),
                            h.restore();
                ...
                this.update = function(a) {
                    ...
                    this.duration > this.maxDuration) {
                        if ("indefinite" != this.attribute("repeatCount").value && "indefinite" != this.attribute("repeatDur").value)
                            return "remove" == this.attribute("fill").valueOrDefault("remove") && !this.removed && (this.removed = !0,
            ...
            a.Element.feGaussianBlur = function(b) {
                ...
                this.apply = function(b, c, d, e, f) {
                    return "undefined" == typeof stackBlurCanvasRGBA ? void ("undefined" != typeof console && console.log("ERROR: StackBlur.js must be included for blur to work")) : (b.canvas.id = a.UniqueId(),
                    b.canvas.style.display = "none",
                    document.body.appendChild(b.canvas),
                    stackBlurCanvasRGBA(b.canvas.id, c, d, e, f, this.blurRadius),
                    void document.body.removeChild(b.canvas))
                }
            }
            ,
    ...
    joint.dia.Paper.prototype.toDataURL = function(a, b) {
        ...
        if (b.width && b.height)
            c = b.width,
            d = b.height,
            g.left + g.right >= c && (g.left = g.right = 0),
            g.top + g.bottom >= d && (g.top = g.bottom = 0),
            f = c - g.left - g.right,
            e = d - g.top - g.bottom;
        else {
        ...
        j.onload = function() {
            function h() {
                ...
                n.height = d,
                m = n.getContext("2d"),
                m.fillStyle = b.backgroundColor || "white",
                m.fillRect(0, 0, c, d)
            }
            function k() {
                l = n.toDataURL(b.type, b.quality),
                a(l),
                n.svg && _.isFunction(n.svg.stop) && _.defer(n.svg.stop)
            }
            var l, m, n;
            h();
            try {
                m.drawImage(j, g.left, g.top, f, e),
                k()
            } catch (o) {
        ...
        ,
        this.toSVG(function(a) {
            i = a = a.replace('width="100%"', 'width="' + f + '"').replace('height="100%"', 'height="' + e + '"'),
            j.src = "data:image/svg+xml," + encodeURIComponent(a)
        }, {
            convertImagesToDataUris: !0
        })
    }
    ...
    !function() {
        function a(a, b) {
            ...
            b.scrollLeft = this.el.scrollLeft,
            b.scrollTop = this.el.scrollTop,
            c.attr({
                width: "100%",
                height: "100%",
                viewBox: [h.x, h.y, h.width, h.height].join(" ")
            }),
            this.$el.addClass("printarea").addClass(a.size),
            a.detachBody && (b.$parent = this.$el.parent(),
            b.index = b.$parent.children().index(this.$el),
            b.$content = $(document.body).children().detach(),
        ...
        function b(a, b) {
            ...
            !d && !e || b.attrs.viewBox || (c.node.removeAttributeNS(null , "viewBox"),
            delete b.attrs.viewBox),
            c.attr(b.attrs),
            this.$el.removeClass("printarea").removeClass(a.size),
            a.detachBody && (b.$parent.children().length ? b.$parent.children().eq(b.index).before(this.$el) : this.$el.appendTo(b.$parent),
            b.$content.appendTo(document.body)),
            this.el.scrollLeft = b.scrollLeft,
            this.el.scrollTop = b.scrollTop
        }
        ...
        joint.dia.Paper.prototype.print = function(d) {
            ...
            var e = {}
              , f = _.bind(a, this, d, e)
              , g = _.bind(b, this, d, e);
            if (c ? ($(window).one("beforeprint", f),
            $(window).one("afterprint", g)) : f(),
            window.print(),
            !c) {
                var h = _.once(g);
                $(document).one("mouseover", h),
                _.delay(h, 1e3)
            }
        }
    }();
    ...
    joint.com.Channel = function(a) {
        ...
        this.options.serverShouldSendGraph = !!_.isUndefined(this.options.serverShouldSendGraph) || this.options.serverShouldSendGraph,
    ...
    joint.com.Channel.prototype.healthCheck = function() {
        this.options.debugLevel > 0 && this.log("healthCheck", _.object(_.keys(this.sites), _.pluck(this.sites, "ttl"))),
        _.each(this.sites, function(a, b) {
            b !== this.id && (a.socket && 1 === a.socket.readyState ? a.ttl = this.options.ttl : a.ttl -= 1,
            a.ttl <= 0 && (delete this.sites[b],
            delete this.state[b]))
        }, this)
    }
    ,
    ...
    joint.com.Channel.prototype.onMessage = function(a, b) {
        ...
        if ("notification" == b.type)
            ...
            !!this._isClient || this.sendNotification(b);
        var d = b.data;
        if (this._isClient) {
        ...
        "graph" === d.action ? this.state[d.channelId] = d.state[d.channelId] : this.state[d.channelId] = (this.state[d.channelId] || 0) + 1,
        this.options.debugLevel > 1 && this.log("new state", this.state),
        this.execute(d),
        _.each(this.sites, function(a, b) {
            b !== this.id && b !== d.channelId && this.receive(a, b, d)
        }, this),
        this._isClient || (b.op = d,
    ...
    joint.com.Channel.prototype.receive = function(a, b, c) {
        ...
        a.outgoing = _.filter(a.outgoing, function(a) {
    ...
    joint.com.Channel.prototype.broadcast = function(a) {
        this._isClient ? a.target = _.keys(this.sites) : a.target = _.keys(_.omit(this.sites, this.id, a.source)),
        this.send()
    }
    ,
    joint.com.Channel.prototype.send = function() {
        if (!this._paused)
            for (var a; a = this.messageQueue.shift(); )
                this.sendMessage(a)
    }
    ,
    joint.com.Channel.prototype.sendMessage = function(a) {
        if (!this._paused && !this._closed) {
            this.trigger("message:sent", a),
            this.debugLevel > 1 && this.log("sendMessage", a);
            for (var b; b = a.target.shift(); ) {
                var c = this.sites[b];
                c && c.socket && 1 === c.socket.readyState && (this.debugLevel > 1 && this.log("sendMessage", b, a),
                c.socket.send(JSON.stringify(a)))
            }
            return !0
        }
    }
    ...
    joint.alg.PriorityQueue.prototype.remove = function() {
        var a = this.data
          , b = a[0]
          , c = a.pop();
        return delete this.index[a.length],
        a.length > 0 && (a[0] = c,
    ...
    joint.storage.Local = {
        ...
        insert: function(a, b, c) {
            ...
            this.callback(c, null , _.extend({}, b, {
                id: d
            }))
        },
        find: function(a, b, c) {
        ...
        remove: function(a, b, c) {
            ...
            this.callback(c, null )) : b.id && (_.remove(d.keys, function(a) {
                return a === b.id
            }),
