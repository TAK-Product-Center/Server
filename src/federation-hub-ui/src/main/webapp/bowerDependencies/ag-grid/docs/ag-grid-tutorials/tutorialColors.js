    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var gridOptions = {
            columnDefs: [
                ...
                {headerName: 'Jan', field: 'jan', monthIndex: 0, valueGetter: monthValueGetter, cellClassRules: monthCellClassRules},
                {headerName: 'Feb', field: 'feb', monthIndex: 1, valueGetter: monthValueGetter, cellClassRules: monthCellClassRules},
                {headerName: 'Mar', field: 'mar', monthIndex: 2, valueGetter: monthValueGetter, cellClassRules: monthCellClassRules},
                {headerName: 'Apr', field: 'apr', monthIndex: 3, valueGetter: monthValueGetter, cellClassRules: monthCellClassRules},
                {headerName: 'May', field: 'may', monthIndex: 4, valueGetter: monthValueGetter, cellClassRules: monthCellClassRules},
