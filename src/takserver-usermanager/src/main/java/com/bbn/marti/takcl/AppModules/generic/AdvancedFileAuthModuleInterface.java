...
/**
 * This is split out from the basic one so all the external methods the online one provides doesn't have to be provided
 * by the offline one which only implements this.
 */
public interface AdvancedFileAuthModuleInterface {
	...
	String usermod(
			...
			@ParamTag(optional = true, shortSpecifier = "-a", longSpecifier = "--append", allowedMultiple = false,
				description = "If supplied with the group modification commands, instead of replacing the users groups the specified group will be appended to the existing groups.")
			@Nullable Boolean appendGroups,

			@ParamTag(optional = true, shortSpecifier = "-r", longSpecifier = "--remove",
				description = "If supplied with the group modification commands, instead of replacing the users groups the specified group will be removed from the existing groups.")
			@Nullable Boolean removeGroups,

			@ParamTag(optional = true, shortSpecifier = "-s", longSpecifier = "--status", isToggle = true,
				description = "Displays the status for a user such as group membership. All other optional parameters will be ignored.")
			@Nullable Boolean displayInfo
