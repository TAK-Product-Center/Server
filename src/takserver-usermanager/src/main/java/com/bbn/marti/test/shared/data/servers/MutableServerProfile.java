...
public class MutableServerProfile extends AbstractServerProfile {
	...
	public static class Builder {
		...
		public MutableServerProfile create() {
			return new MutableServerProfile(
					this.baseServer,
					identifier,
					host == null ? baseServer.getHost() : host,
					...
					baseServer.getAdminuserIdentifier()
			);
		}
	}
	...
	public MutableServerProfile(@NotNull AbstractServerProfile baseProfile, @NotNull String identifier, @NotNull String host, @Nullable Integer igniteDiscoveryPort, @Nullable Integer igniteDiscoveryPortCount, @Nullable Integer igniteCommunicationPort,
            @Nullable Integer igniteCommunicationPortCount,int federationPort, int federationV2Port, int certHttpsPort, int fedHttpsPort, int httpPlaintextPort, int httpsPort, String dbHost, String adminUsername) {
		super(identifier, host, igniteDiscoveryPort, igniteDiscoveryPortCount, igniteCommunicationPort, igniteCommunicationPortCount, federationPort, federationV2Port, certHttpsPort, fedHttpsPort, httpPlaintextPort, httpsPort, dbHost, adminUsername);
