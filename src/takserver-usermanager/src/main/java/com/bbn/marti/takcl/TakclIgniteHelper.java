...
public class TakclIgniteHelper {
	...
	public static final void overrideServerConfigurationFromCoreConfig(@NotNull AbstractServerProfile serverProfile,
        ...
        // Get an identifier for the service based on the jar name
        String identifier = new java.io.File(TakclIgniteHelper.class.getProtectionDomain()
            .getCodeSource().getLocation().getPath()).getName().replace(".jar", "").toLowerCase();

		String igniteProfile = identifier + identifierCounter.getAndIncrement();
