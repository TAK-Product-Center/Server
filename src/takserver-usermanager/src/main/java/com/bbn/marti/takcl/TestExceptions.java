...
public class TestExceptions {
    ...
    public static boolean MISSION_IGNORE_GROUPS_MISSING_IN_ADD_RESOURCE_RESPONSE = parseEnvVarBool("MISSION_IGNORE_GROUPS_MISSING_IN_ADD_RESOURCE_RESPONSE", true);
    public static boolean MISSION_IGNORE_GROUPS_MISSING_IN_REMOVE_RESOURCE_RESPONSE = parseEnvVarBool("MISSION_IGNORE_GROUPS_MISSING_IN_REMOVE_RESOURCE_RESPONSE", true);
    public static boolean MISSION_IGNORE_GROUPS_MISSING_IN_ADD_MISSION_RESPONSE = parseEnvVarBool("MISSION_IGNORE_GROUPS_MISSING_IN_ADD_MISSION_RESPONSE", true);
    ...
    public static boolean USE_TAKCL_IGNITE_CONFIGURATION_AS_INDICATED =
        parseEnvVarBool("USE_TAKCL_IGNITE_CONFIGURATION_AS_INDICATED", false);

    // The MissionDataSyncInterface.addMissionContents does not hydrate UID objects for the return call
    public static boolean MISSION_IGNORE_ADD_RESOURCE_RESPONSE_MISSING_UID_OBJECTS =
        parseEnvVarBool("MISSION_IGNORE_ADD_RESOURCE_RESPONSE_MISSING_UID_OBJECTS", false);

    // The UID objects are now returned with the add resource response, but not the details
    public static boolean MISSION_IGNORE_ADD_RESOURCE_RESPONSE_MISSING_UID_DETAILS =
        parseEnvVarBool("MISSION_IGNORE_ADD_RESOURCE_RESPONSE_MISSING_UID_DETAILS", true);

    // If the default role is read only, an admin cannot send CoT data to the mission. This is compounded by the fact
