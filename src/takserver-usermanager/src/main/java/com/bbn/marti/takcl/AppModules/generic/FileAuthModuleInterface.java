...
public interface FileAuthModuleInterface extends AdvancedFileAuthModuleInterface {
    ...
    String usermod(
        ...
        @ParamTag(optional = true, shortSpecifier = "-a", longSpecifier = "--append", isToggle = true,
        ...
        @ParamTag(optional = true, shortSpecifier = "-r", longSpecifier = "--remove", isToggle = true,
        ...
        @ParamTag(optional = true, shortSpecifier = "-s", longSpecifier = "--status", isToggle = true,
            description = "Displays details for a user such as group membership. All other optional parameters will be ignored.")
