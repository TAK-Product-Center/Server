...
public class MissionInvitation implements Serializable, Comparable<MissionInvitation> {
    ...
    public enum Type {
        clientUid, callsign, user, group, team
    }
    ...
    // no-arg constructor
    public MissionInvitation(String missionName, String invitee, String type, String creatorUid, Date createTime, String token, MissionRole role) {
