...
public interface MissionRepository extends JpaRepository<Mission, Long> {
    ...
    @Query(value = "select id, create_time, name, creatoruid, groups, description, chatroom, tool, parent_mission_id, password_hash, default_role_id, expiration from mission where name = :name ", nativeQuery = true)
    ...
    @Query(value = "select id, create_time, name, creatoruid, groups, description, chatroom, tool, parent_mission_id, password_hash, default_role_id, expiration from mission where" +
    ...
    @Query(value = "insert into mission (create_time, name, creatoruid, groups, description, chatroom, tool, password_hash, expiration) values (:createTime, :name, :creatorUid, "
            + RemoteUtil.GROUP_VECTOR + ", :description, :chatRoom, :tool, :passwordHash, :expiration) returning id", nativeQuery = true)
    Long create(@Param("createTime") Date createTime, @Param("name") String name, @Param("creatorUid") String creatorUid, @Param("groupVector")
            String groupVector, @Param("description") String description, @Param("chatRoom") String chatRoom, @Param("tool") String tool, @Param("passwordHash") String passwordHash, @Param("expiration") Long expiration);

    @Query(value = "insert into mission (create_time, name, creatoruid, groups, description, chatroom, tool, password_hash, default_role_id, expiration) values (:createTime, :name, :creatorUid, "
            + RemoteUtil.GROUP_VECTOR + ", :description, :chatRoom, :tool, :passwordHash, :defaultRoleId, :expiration) returning id", nativeQuery = true)
    Long create(@Param("createTime") Date createTime, @Param("name") String name, @Param("creatorUid") String creatorUid, @Param("groupVector") String groupVector, @Param("description") String description, @Param("chatRoom") String chatRoom, @Param("tool") String tool, @Param("passwordHash") String passwordHash,
                @Param("defaultRoleId") Long defaultRoleId, @Param("expiration") Long expiration);

    @Query(value = "update mission set description = :description, chatroom = :chatRoom, expiration = :expiration where name = :name and" + RemoteUtil.GROUP_CLAUSE + " returning id", nativeQuery = true)
    Long update(@Param("name") String name, @Param("groupVector") String groupVector, @Param("description") String description,
                @Param("chatRoom") String chatRoom, @Param("expiration") Long expiration);
