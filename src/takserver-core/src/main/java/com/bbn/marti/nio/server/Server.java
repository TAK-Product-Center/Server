...
*
* <p> The server is responsible for handling scheduling and guaranteeing ordering of calls.
* A server makes different guarantees about different scheduling strategies in terms of the number of threads servicing
