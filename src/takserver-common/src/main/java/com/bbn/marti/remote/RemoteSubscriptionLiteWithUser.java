...
public class RemoteSubscriptionLiteWithUser implements Serializable {
    ...
    public RemoteSubscriptionLiteWithUser(RemoteSubscription remoteSubscription) {
    	...
    	this.user = remoteSubscription.user;
    }
