...
public class RolMissionPackageTests {

//    static final String ROL_RESOURCE_PATH = File.separator + "rol" + File.separator;
    static final String ROL_RESOURCE_MP_PATH = File.separator + "rol" + File.separator + "mp" + File.separator;

    public static final Logger logger = LoggerFactory.getLogger(RolMissionPackageTests.class);

    @Test
    public void parser() throws Exception {

        // get all the files the rol dir
        URL rolRootUrl = getClass().getResource(ROL_RESOURCE_MP_PATH);
