 ...
 * 
 */
public class MissionRolTests {

    public static final Logger logger = LoggerFactory.getLogger(MissionRolTests.class);

    private static final String ROL_RESOURCE_MISSION_PATH = File.separator + "rol" + File.separator + "mission" + File.separator;
