...
public class MissionModels {
    ...
    public static final Pattern MISSION_UID_DETAILS_PATTERN = Pattern.compile("^Mission\\.uids\\.[0-9]*\\.details");
    ...
    /**
     * Used to track the position in a json tree to simplify error determination. It attempts to chain json tree position
     * data together to help aid in error determination
     */
    public static class RecursiveMetadata {
        /**
         * The parameter name being specified
         */
        public final String parameterName;

        /**
         * An optional hint related to the actual data to try and assist in error determination
         */
        public final String actualHint;

        /**
         * An optional hint related to the expected data to try and assist in error determination
         */
    ...
    public static class MissionContentDataContainerDeserializer implements JsonDeserializer<MissionContentDataContainer> {
        ...
        /**
         * Parses the data object from missions to something that can be reasonably validated against
         *
         * @param json    The raw json element
         * @param typeOfT The expected class type
         * @param context json context for deserialization
         * @return A deserialization instance
         * @throws JsonParseException If it fails to parse the data
         */
        @Override
    ...
    /**
     * An annotation used on object properties such as hints to indicate they should be ignored during comparison.
     */
    ...
    /**
     * A base object to allow comparison of two objects with exceptions and metadata for tracking discrepancies
     *
    ...
    public static abstract class AssertableObject<T extends AssertableObject<T>> implements Comparable<T> {
        ...
        private static boolean assertEnumsEqual(@NotNull RecursiveMetadata metadata, @Nullable Object expectedValue, @Nullable Object actualValue) {
            ...
            if ((expectedValue != null && expectedValue != actualValue) ||
                (actualValue != null && actualValue != expectedValue)) {
                String actualStr = actualValue == null ? null : actualValue.toString();
                String expectedStr = expectedValue == null ? null : expectedValue.toString();
                Assert.assertRecursiveFailure(metadata, expectedStr, actualStr);
                return false;
        ...
        /**
         * Asserts this object  matches the desired object with allocation for some exceptions
         *
         * @param desiredObject
         * @param expectationOverrides
         * @return
         */
...
//		protected JsonElement externalData;
        ...
        public void overrideGroups(TreeSet<String> groups) {
            if (!(TestExceptions.MISSION_IGNORE_GROUPS_MISSING_IN_ADD_RESOURCE_RESPONSE ||
                TestExceptions.MISSION_IGNORE_GROUPS_MISSING_IN_REMOVE_RESOURCE_RESPONSE ||
                TestExceptions.MISSION_IGNORE_GROUPS_MISSING_IN_ADD_MISSION_RESPONSE)) {
